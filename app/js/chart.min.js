...
jQuery(document).ready(function (e) {
    new Chart(document.getElementById("line-chart").getContext("2d")).Line({
        ...
        scaleStepWidth: 10,
        scaleStartValue: 0
    }), new Chart(document.getElementById("pie-chart").getContext("2d")).Pie([{
        value: 10,
        color: "#93979b"
    }, {
        value: 55,
    ...
    e("#purple-dougnut").each(function () {
        new Chart(this.getContext("2d")).Doughnut([{
            value: 30,
            color: "#b6b8bb"
        }, {
            value: 10,
    ...
    }), new Chart(document.getElementById("polar-chart").getContext("2d")).PolarArea([{
        value: 30,
        color: "b6b8bb"
    }, {
        value: 10,
