...
jQuery(document).ready(function (t) {
    ...
    function (t) {
        ...
        ! function () {
            ...
            t.position = {
                    ...
                    return b = s(y), y[0].preventDefault && (n.at = "left top"), m = b.width, g = b.height, v = b.offset, _ = t.extend({}, v), t.each(["my", "at"], function () {
                        ...
                        "right" === n.my[0] ? I.left -= u : "center" === n.my[0] && (I.left -= u / 2), "bottom" === n.my[1] ? I.top -= d : "center" === n.my[1] && (I.top -= d / 2), I.left += M[0], I.top += M[1], o || (I.left = h(I.left), I.top = h(I.top)), s = {
                            marginLeft: f,
                            marginTop: b
                    ...
                    flip: {
                        ...
                        top: function (t, e) {
                            var i, s, n = e.within,
                                ...
                                m = -2 * e.offset[1];
                            c < 0 ? (s = t.top + p + f + m + e.collisionHeight - a - o, (s < 0 || s < r(c)) && (t.top += p + f + m)) : u > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + m - h, (i > 0 || r(i) < u) && (t.top += p + f + m))
                        }
                    },
                    flipfit: {
                        left: function () {
                ...
                function () {
                    ...
                    e.appendChild(h), i = r || document.documentElement, i.insertBefore(e, i.firstChild), h.style.cssText = "position: absolute; left: 10.7432222px;", n = t(h).offset().left, o = n > 10 && n < 11, e.innerHTML = "", i.removeChild(e)
                }()
        }();
        ...
        t.extend(n.prototype, {
            ...
            parseDate: function (e, i, s) {
                ...
                if (m === -1 ? m = (new Date).getFullYear() : m < 100 && (m += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (m <= c ? 0 : -100)), _ > -1)
                    for (g = 1, v = _;;) {
            ...
            _generateHTML: function (t) {
                var e, i, s, n, o, a, r, h, l, c, u, d, p, f, m, g, v, _, b, y, w, x, k, C, D, T, I, M, P, S, z, A, H, E, N, O, W, F, R, L = new Date,
                ...
                for (t.drawMonth = Z, t.drawYear = tt, i = this._get(t, "prevText"), i = K ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, Z - X, 1)), this._getFormatConfig(t)) : i, s = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "e" : "w") + "'>" + i + "</span></a>" : q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "e" : "w") + "'>" + i + "</span></a>", n = this._get(t, "nextText"), n = K ? this.formatDate(n, this._daylightSavingAdjust(new Date(tt, Z + X, 1)), this._getFormatConfig(t)) : n, o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + n + "</span></a>" : q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + n + "</span></a>", a = this._get(t, "currentText"), r = this._get(t, "gotoCurrent") && t.currentDay ? G : j, a = K ? this.formatDate(a, r, this._getFormatConfig(t)) : a, h = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", l = B ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (Y ? h : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (Y ? "" : h) + "</div>" : "", c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, u = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), m = this._get(t, "monthNamesShort"), g = this._get(t, "beforeShowDay"), v = this._get(t, "showOtherMonths"), _ = this._get(t, "selectOtherMonths"), b = this._getDefaultDate(t), y = "", x = 0; x < U[0]; x++) {
                    for (k = "", this.maxRows = 4, C = 0; C < U[1]; C++) {
                        if (D = this._daylightSavingAdjust(new Date(tt, Z, t.selectedDay)), T = " ui-corner-all", I = "", $) {
                            if (I += "<div class='ui-datepicker-group", U[1] > 1) switch (C) {
                                case 0:
                                    I += " ui-datepicker-group-first", T = " ui-corner-" + (Y ? "right" : "left");
                                    break;
                                case U[1] - 1:
                                    I += " ui-datepicker-group-last", T = " ui-corner-" + (Y ? "left" : "right");
                                    break;
                                default:
                        ...
                        for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === x ? Y ? o : s : "") + (/all|right/.test(T) && 0 === x ? Y ? s : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, x > 0 || C > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", M = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; w < 7; w++) P = (w + c) % 7, M += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[P] + "'>" + p[P] + "</span></th>";
                        for (I += M + "</tr></thead><tbody>", S = this._getDaysInMonth(tt, Z), tt === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, S)), z = (this._getFirstDayOfMonth(tt, Z) - c + 7) % 7, A = Math.ceil((z + S) / 7), H = $ && this.maxRows > A ? this.maxRows : A, this.maxRows = H, E = this._daylightSavingAdjust(new Date(tt, Z, 1 - z)), N = 0; N < H; N++) {
                            for (I += "<tr>", O = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(E) + "</td>" : "", w = 0; w < 7; w++) W = g ? g.apply(t.input ? t.input[0] : null, [E]) : [!0, ""], F = E.getMonth() !== Z, R = F && !_ || !W[0] || Q && E < Q || J && E > J, O += "<td class='" + ((w + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (F ? " ui-datepicker-other-month" : "") + (E.getTime() === D.getTime() && Z === t.selectedMonth && t._keyEvent || b.getTime() === E.getTime() && b.getTime() === D.getTime() ? " " + this._dayOverClass : "") + (R ? " " + this._unselectableClass + " ui-state-disabled" : "") + (F && !v ? "" : " " + W[1] + (E.getTime() === G.getTime() ? " " + this._currentClass : "") + (E.getTime() === j.getTime() ? " ui-datepicker-today" : "")) + "'" + (F && !v || !W[2] ? "" : " title='" + W[2].replace(/'/g, "&#39;") + "'") + (R ? "" : " data-handler='selectDay' data-event='click' data-month='" + E.getMonth() + "' data-year='" + E.getFullYear() + "'") + ">" + (F && !v ? "&#xa0;" : R ? "<span class='ui-state-default'>" + E.getDate() + "</span>" : "<a class='ui-state-default" + (E.getTime() === j.getTime() ? " ui-state-highlight" : "") + (E.getTime() === G.getTime() ? " ui-state-active" : "") + (F ? " ui-priority-secondary" : "") + "' href='#'>" + E.getDate() + "</a>") + "</td>", E.setDate(E.getDate() + 1), E = this._daylightSavingAdjust(E);
                            I += O + "</tr>"
                        }
                        Z++, Z > 11 && (Z = 0, tt++), I += "</tbody></table>" + ($ ? "</div>" + (U[0] > 0 && C === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""), k += I
                    }
                    y += k
                }
        ...
        t.effects, t.effects.effect.blind = function (e, i) {
            ...
            for ((c || l) && r.push("opacity"), t.effects.save(a, r), a.show(), t.effects.createWrapper(a), d || (d = a["top" === v ? "outerHeight" : "outerWidth"]() / 3), c && (o = {
                    opacity: 1
                }, o[v] = 0, a.css("opacity", 0).css(v, _ ? 2 * -d : 2 * d).animate(o, m, g)), l && (d /= Math.pow(2, p - 1)), o = {}, o[v] = 0, s = 0; s < p; s++) n = {}, n[v] = (_ ? "-=" : "+=") + d, a.animate(n, m, g).animate(o, m, g), d = l ? 2 * d : d / 2;
            l && (n = {
                opacity: 0
            ...
            var o, a, r, h, l, c, u = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3,
                ...
                b = [];
            for (o = 0; o < u; o++)
                for (h = g.top + o * _, c = o - (u - 1) / 2, a = 0; a < d; a++) r = g.left + a * v, l = a - (d - 1) / 2, p.clone().appendTo("body").wrap("<div></div>").css({
                    position: "absolute",
                    visibility: "visible",
                    left: -a * v,
                    top: -o * _
    ...
    function (t) {
        ...
        t.fn.attr2 = function () {
            ...
            function i(i) {
                var s, n, o = t.param(i, e.traditional).split("&"),
                    a = o.length,
                    r = [];
                for (s = 0; s < a; s++) o[s] = o[s].replace(/\+/g, " "), n = o[s].split("="), r.push([decodeURIComponent(n[0]), decodeURIComponent(n[1])]);
                return r
            }
            ...
            function a(s) {
                ...
                return r.beforeSend = function (t, i) {
                    e.formData ? i.data = e.formData : i.data = n, l && l.call(this, t, i)
                }, t.ajax(r)
            }
                ...
                function a() {
                    function e() {
                        try {
                            ...
                            s("Server abort: ", i, " (", i.name, ")"), r(T), x && clearTimeout(x), x = void 0
                        }
                    }
                    var i = u.attr2("target"),
                        o = u.attr2("action");
                    k.setAttribute("target", f), h && !/post/i.test(h) || k.setAttribute("method", "POST"), o != d.url && k.setAttribute("action", d.url), d.skipEncodingOverride || h && !/post/i.test(h) || u.attr({
                    ...
                    try {
                        if (d.extraData)
                            for (var l in d.extraData) d.extraData.hasOwnProperty(l) && (t.isPlainObject(d.extraData[l]) && d.extraData[l].hasOwnProperty("name") && d.extraData[l].hasOwnProperty("value") ? a.push(t('<input type="hidden" name="' + d.extraData[l].name + '">').val(d.extraData[l].value).appendTo(k)[0]) : a.push(t('<input type="hidden" name="' + l + '">').val(d.extraData[l]).appendTo(k)[0]));
                        ...
                        k.setAttribute("action", o), i ? k.setAttribute("target", i) : u.removeAttr("target"), t(a).remove()
                    }
                }

                function r(e) {
                    if (!_.aborted && !z) {
                        if (S = n(v), S || (s("cannot access response document"), e = T), e === D && _) return _.abort("timeout"), void C.reject(_, "timeout");
                        if (e == T && _) return _.abort("server abort"), void C.reject(_, "error", "server abort");
                        if (S && S.location.href != d.iframeSrc || w) {
                            v.detachEvent ? v.detachEvent("onload", r) : v.removeEventListener("load", r, !1);
                            var i, o = "success";
                            try {
                                if (w) throw "timeout";
                                var a = "xml" == d.dataType || S.XMLDocument || t.isXMLDoc(S);
                                if (s("isXml=" + a), !a && window.opera && (null === S.body || !S.body.innerHTML) && --A) return s("requeing onLoad callback, DOM not available"), void setTimeout(r, 250);
                                var h = S.body ? S.body : S.documentElement;
                                _.responseText = h ? h.innerHTML : null, _.responseXML = S.XMLDocument ? S.XMLDocument : S, a && (d.dataType = "xml"), _.getResponseHeader = function (t) {
                                    var e = {
                                        "content-type": d.dataType
                                    };
                                    return e[t.toLowerCase()]
                                }, h && (_.status = Number(h.getAttribute("status")) || _.status, _.statusText = h.getAttribute("statusText") || _.statusText);
                                var l = (d.dataType || "").toLowerCase(),
                                    c = /(json|script|text)/.test(l);
                                if (c || d.textarea) {
                                    var u = S.getElementsByTagName("textarea")[0];
                                    if (u) _.responseText = u.value, _.status = Number(u.getAttribute("status")) || _.status, _.statusText = u.getAttribute("statusText") || _.statusText;
                                    else if (c) {
                                        var f = S.getElementsByTagName("pre")[0],
                                            m = S.getElementsByTagName("body")[0];
                                        f ? _.responseText = f.textContent ? f.textContent : f.innerText : m && (_.responseText = m.textContent ? m.textContent : m.innerText)
                                    }
                                } else "xml" == l && !_.responseXML && _.responseText && (_.responseXML = H(_.responseText));
                                try {
                                    P = N(_, l, d)
                                } catch (b) {
                                    o = "parsererror", _.error = i = b || o
                                }
                            } catch (b) {
                                s("error caught: ", b), o = "error", _.error = i = b || o
                            }
                            _.aborted && (s("upload aborted"), o = null), _.status && (o = _.status >= 200 && _.status < 300 || 304 === _.status ? "success" : "error"), "success" === o ? (d.success && d.success.call(d.context, P, "success", _), C.resolve(_.responseText, "success", _), p && t.event.trigger("ajaxSuccess", [_, d])) : o && (void 0 === i && (i = _.statusText), d.error && d.error.call(d.context, _, o, i), C.reject(_, "error", i), p && t.event.trigger("ajaxError", [_, d, i])), p && t.event.trigger("ajaxComplete", [_, d]), p && !--t.active && t.event.trigger("ajaxStop"), d.complete && d.complete.call(d.context, _, o), z = !0, d.timeout && clearTimeout(x), setTimeout(function () {
                                d.iframeTarget ? g.attr("src", d.iframeSrc) : g.remove(), _.responseXML = null
                            }, 100)
                        }
                    }
                }
                var l, c, d, p, f, g, v, _, b, y, w, x, k = u[0],
                    C = t.Deferred();
                if (C.abort = function (t) {
                        _.abort(t)
                    }, i)
                    for (c = 0; c < m.length; c++) l = t(m[c]), o ? l.prop("disabled", !1) : l.removeAttr("disabled");
                if (d = t.extend(!0, {}, t.ajaxSettings, e), d.context = d.context || d, f = "jqFormIO" + (new Date).getTime(), d.iframeTarget ? (g = t(d.iframeTarget), y = g.attr2("name"), y ? f = y : g.attr2("name", f)) : (g = t('<iframe name="' + f + '" src="' + d.iframeSrc + '" />'), g.css({
                        position: "absolute",
                        top: "-1000px",
                        left: "-1000px"
                    })), v = g[0], _ = {
                        ...
                        abort: function (e) {
                            ...
                            g.attr("src", d.iframeSrc), _.error = i, d.error && d.error.call(d.context, _, i, e), p && t.event.trigger("ajaxError", [_, d, i]), d.complete && d.complete.call(d.context, _, i)
                        }
                    }, p = d.global, p && 0 === t.active++ && t.event.trigger("ajaxStart"), p && t.event.trigger("ajaxSend", [_, d]), d.beforeSend && d.beforeSend.call(d.context, _, d) === !1) return d.global && t.active--, C.reject(), C;
                if (_.aborted) return C.reject(), C;
                b = k.clk, b && (y = b.name, y && !b.disabled && (d.extraData = d.extraData || {}, d.extraData[y] = b.value, "image" == b.type && (d.extraData[y + ".x"] = k.clk_x, d.extraData[y + ".y"] = k.clk_y)));
                var D = 1,
                    T = 2,
                    I = t("meta[name=csrf-token]").attr("content"),
                    M = t("meta[name=csrf-param]").attr("content");
                M && I && (d.extraData = d.extraData || {}, d.extraData[M] = I), d.forceSync ? a() : setTimeout(a, 10);
                var P, S, z, A = 50,
                    ...
                    N = function (e, i, s) {
                        ...
                        return o && "parsererror" === a.documentElement.nodeName && t.error && t.error("parsererror"), s && s.dataFilter && (a = s.dataFilter(a, i)), "string" == typeof a && ("json" === i || !i && n.indexOf("json") >= 0 ? a = E(a) : ("script" === i || !i && n.indexOf("javascript") >= 0) && t.globalEval(a)), a
                    };
                return C
            }
            ...
            "function" == typeof e ? e = {
                success: e
            } : void 0 === e && (e = {}), h = e.type || this.attr2("method"), l = e.url || this.attr2("action"), c = "string" == typeof l ? t.trim(l) : "", c = c || window.location.href || "", c && (c = (c.match(/^([^#]+)/) || [])[1]), e = t.extend(!0, {
                url: c,
            ...
            var d = {};
            if (this.trigger("form-pre-serialize", [this, e, d]), d.veto) return s("ajaxSubmit: submit vetoed via form-pre-serialize trigger"), this;
            if (e.beforeSerialize && e.beforeSerialize(this, e) === !1) return s("ajaxSubmit: submit aborted via beforeSerialize callback"), this;
            var p = e.traditional;
            void 0 === p && (p = t.ajaxSettings.traditional);
            var f, m = [],
                g = this.formToArray(e.semantic, m);
            if (e.data && (e.extraData = e.data, f = t.param(e.data, p)), e.beforeSubmit && e.beforeSubmit(g, this, e) === !1) return s("ajaxSubmit: submit aborted via beforeSubmit callback"), this;
            if (this.trigger("form-submit-validate", [g, this, e, d]), d.veto) return s("ajaxSubmit: submit vetoed via form-submit-validate trigger"), this;
            var v = t.param(g, p);
            ...
            if (e.resetForm && _.push(function () {
                ...
                _.push(function (i) {
                    ...
                    t(e.target)[s](i).each(b, arguments)
                })
            } else e.success && _.push(e.success);
            if (e.success = function (t, i, s) {
                    for (var n = e.context || this, o = 0, a = _.length; o < a; o++) _[o].apply(n, [t, i, s || u, u])
                }, e.error) {
                var y = e.error;
            ...
            var x = t("input[type=file]:enabled", this).filter(function () {
                ...
                D = u.attr("enctype") == C || u.attr("encoding") == C,
                T = n.fileapi && n.formdata;
            s("fileAPI :" + T);
            var I, M = (k || D) && !T;
            e.iframe !== !1 && (e.iframe || M) ? e.closeKeepAlive ? t.get(e.closeKeepAlive, function () {
                I = r(g)
            }) : I = r(g) : I = (k || D) && T ? a(g) : t.ajax(e), u.removeData("jqxhr").data("jqxhr", I);
            for (var P = 0; P < m.length; P++) m[P] = null;
            return this.trigger("form-submit-notify", [this, e]), this
        }, t.fn.ajaxForm = function (n) {
            if (n = n || {}, n.delegation = n.delegation && t.isFunction(t.fn.on), !n.delegation && 0 === this.length) {
                var o = {
                    s: this.selector,
                    c: this.context
                };
                return !t.isReady && o.s ? (s("DOM not ready, queuing ajaxForm"), t(function () {
                    t(o.s, o.c).ajaxForm(n)
            ...
            var o = this[0],
                a = e ? o.getElementsByTagName("*") : o.elements;
            if (!a) return s;
            var r, h, l, c, u, d, p;
            for (r = 0, d = a.length; r < d; r++)
                if (u = a[r], l = u.name, l && !u.disabled)
                    if (e && o.clk && "image" == u.type) o.clk == u && (s.push({
                        name: l,
                        value: t(u).val(),
                        type: u.type
                    }), s.push({
                ...
                for (i && i.push(u), h = 0, p = c.length; h < p; h++) s.push({
                    name: l,
                    value: c[h]
                });
            ...
            } else null !== c && "undefined" != typeof c && (i && i.push(u), s.push({
                name: l,
                value: c,
                type: u.type,
                required: u.required
            ...
            if (!e && o.clk) {
                var m = t(o.clk),
                    g = m[0];
                l = g.name, l && !g.disabled && "image" == g.type && (s.push({
                    name: l,
                    value: m.val()
                }), s.push({
                    name: l + ".x",
            ...
            return this.each(function () {
                ...
                if (s) {
                    ...
                    if (n && n.constructor == Array)
                        for (var o = 0, a = n.length; o < a; o++) i.push({
                            name: s,
                            value: n[o]
                        });
            ...
            if (void 0 === i && (i = !0), i && (!s || e.disabled || "reset" == n || "button" == n || ("checkbox" == n || "radio" == n) && !e.checked || ("submit" == n || "image" == n) && e.form && e.form.clk != e || "select" == o && e.selectedIndex == -1)) return null;
            if ("select" == o) {
                var a = e.selectedIndex;
                if (a < 0) return null;
                for (var r = [], h = e.options, l = "select-one" == n, c = l ? a + 1 : h.length, u = l ? a : 0; u < c; u++) {
                    var d = h[u];
                    if (d.selected) {
                        var p = d.value;
        ...
        function e(t, e, i) {
            i.empty(), i.append('<div class="element-top-20 alert alert-' + e + '" role="alert">' + t.message + "</div>")
        }
        t(".contact-form").on("submit", function (i) {
            var s = t(this),
                n = s.find("button"),
                o = s.find(".messages");
            return i.preventDefault(), s.ajaxSubmit({
                type: "post",
                dataType: "json",
                beforeSubmit: function () {
                    n.attr("disabled", "disabled"), n.find("i").removeClass().addClass("fa fa-circle-o-notch fa-spin")
                },
                success: function (t, i, s, a) {
                    if ("ok" === t.status) {
                        for (var r in t.messages) e(t.messages[r], "success", o);
                        a[0].reset()
                    } else
                        for (var h in t.messages) e(t.messages[h], "danger", o);
                    n.removeAttr("disabled")
                },
                error: function (t) {
                    for (var i in t.messages) e(t.messages[i], "warning", o);
                    n.removeAttr("disabled")
                }
            }), !1
        })
