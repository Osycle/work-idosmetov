...
function oxyThemeScripts(t) {
    function e(e) {
        var i = t(e),
            n = "false" !== i.attr("data-flex-slideshow"),
            ...
            l = "hide" !== i.attr("data-flex-directions"),
            c = "thumbnails" === i.attr("data-flex-controls") ? "thumbnails" : "hide" !== i.attr("data-flex-controls"),
    ...
    function n() {
        t(".masonry").each(function (e, n) {
            var o = t(n),
                s = o.find(".masonry-item"),
                a = o.attr("data-padding"),
                r = (o.parents(".container-fullwidth").length > 0, -a / 2);
            o.css({
                margin: "0 " + r + "px"
            }), o.imagesLoaded().always(function (e) {
                setTimeout(function () {
                    var e = 3,
                        n = t(window).width(),
                        r = 2;
                    n < 768 ? (e = o.attr("data-col-xs"), r = 1) : n < 992 ? (e = o.attr("data-col-sm"), r = 1) : n < 1200 ? (e = o.attr("data-col-md"), r = 2) : n > 1200 && (e = o.attr("data-col-lg"), r = 2);
                    var l;
                    o.hasClass("use-masonry") ? s.each(function () {
                        l = Math.floor(o.width() / e);
                        var i = t(this);
                        i.hasClass("masonry-wide") ? i.css("width", l * r) : i.css("width", l)
                    }) : (l = Math.floor(o.width() / e), s.css("width", l)), s.find(".figure,.post-masonry-inner").css("padding", a / 2 + "px"), o.isotope({
                        ...
                        Waypoint.refreshAll(), o.removeClass("no-transition"), i(s.find(".portfolio-os-animation"), o), i(s.find(".blog-os-animation"), o)
                    })
                }, 200)
            })
        })
    ...
    function o(t, e, i) {
        ...
        return i.length && i.hasClass("navbar-sticky") && a + o <= s && !l && (n += o), n
    }
    ...
    function a(e) {
        ...
        if (void 0 !== c && c.hasClass("navbar-sticky") && u + s <= o && !l) {
            var a = parseInt(oxyThemeData.navbarScrolledPoint),
                r = parseInt(oxyThemeData.navbarHeight),
                d = parseInt(oxyThemeData.navbarScrolled);
            n = a <= o ? d : r, n += c.hasClass("header-logo-center-menu-below") || c.hasClass("header-logo-left-menu-below") || c.hasClass("header-logo-right-menu-below") ? c.find(".nav-container").outerHeight() : 0
        }
        t.scrollTo(i, 800, {
            axis: "y",
            offset: -n + 1
    ...
    function r() {
        i(t(".os-animation")), i(t(".staff-os-animation"), t(".staff-list-container")), i(t(".recent-simple-os-animation"), t(".recent-simple-os-container"))
    }
    ...
    var l = !t('body:not([class*="oxy-agent-"])').length;
    t(".flexslider[id]").each(function () {
        var i = this;
        t(this).imagesLoaded().done(function (t) {
            e(i)
        })
    }), t(window).smartresize(function () {
        n()
    }), n(), t(".portfolio-filter").click(function () {
        var e = t(this),
        ...
        o.isotope({
            ...
            o.each(function () {
                var e = t(this),
                    i = "";
                void 0 !== e.attr("title") && (i = e.attr("title"));
                var n = "image";
                (e.hasClass("magnific-youtube") || e.hasClass("magnific-vimeo")) && (n = "iframe");
                var o = {
                    src: e.attr("href"),
                    type: n,
                    title: i
                ...
                callbacks: {
                    beforeOpen: function () {
                        var t = o.index(this.st.el); - 1 !== t && this.goTo(t)
                    }
                }
            })
        })
        ...
        success: function (e, i, n) {
            var o = t(e).attr("poster"),
                s = !1;
            "undefined" != typeof o && "" !== o && (s = !0, t(e).parent().css("background-image", "url('" + t(e).attr("poster") + "')"));
            var a = t(e).closest("section");
            e.addEventListener("loadeddata", function () {
                var i = a.outerHeight(),
                    ...
                    c = o / r,
                    u = s * c;
                t(e).parent().css("padding-bottom", l), u >= i ? t(e).css("top", (i - s * c) / 2) : t(e).css("background-image", ""), t(e).show(), t(window).smartresize(function () {
                    i = a.outerHeight(), o = a.outerWidth(), c = o / r, u = s * c, u >= i ? t(e).css("top", (i - s * c) / 2) : t(e).css("background-image", "")
                })
            }), t('body[class*="oxy-agent-"]').length && (a.on("click", function (t) {
                e.paused ? e.play() : e.pause()
            }), !s && t("body").hasClass("oxy-agent-iphone") || a.find(".mejs-overlay-play").show(), s && (e.addEventListener("pause", function () {
                a.find(".mejs-overlay-play").show(), t(e).hide()
    ...
    var d = t(".menu").find("a"),
        ...
        p = t("article .bullet-nav");
    if (p.length || h.length) {
        var f = [];
        t("article").find("section").each(function () {
            this.id && f.push(this)
        }), f.length && (h.length && d.parent().removeClass("active current-menu-item"), t.each(f, function (e, i) {
            var n = t(i);
            if (p.length) {
                var a = p.find("ul"),
                    r = "";
                "on" === p.attr("data-show-tooltips") && (r = 'data-toggle="tooltip" data-placement="left" title="' + n.attr("data-label") + '"'), a.append('<li><a href="#' + i.id + '" ' + r + ">" + i.id + "</a>")
            }
            n.waypoint({
                offset: function () {
                    return o(n, "up", c)
        ...
        }), p.length && (p.show(), p.css("top", (t(window).height() - p.height()) / 2)))
    }
    t(".menu a, a.scroll-to-id, .bullet-nav a").on("click", function (t) {
        this.hash && (a(this.hash), t.preventDefault())
    }), t(window).on("load", function () {
        window.location.hash && a(window.location.hash)
    }), t("#wp-calendar").addClass("table"), t("body").on("click", ".top-search:not(.active) .search-trigger", function () {
    ...
    var m = t("body").find(".navbar-sticky");
    if (m.length > 0) {
        new Waypoint.Sticky({
            element: m[0],
    ...
    var g = t("#masthead.navbar-sticky");
    if (g.length && g.hasClass("navbar-sticky")) {
        var v = g.position().top;
        t("body").waypoint({
            offset: -(parseInt(oxyThemeData.navbarScrolledPoint) + v),
            handler: function (t) {
                g.toggleClass("navbar-scrolled");
                var e = "swatch-",
                    i = g[0].className.split(" ").filter(function (t) {
                        return 0 !== t.lastIndexOf(e, 0)
                    });
                g[0].className = i.join(" "), g.one("MSTransitionEnd webkitTransitionEnd oTransitionEnd transitionend", function () {
                    g.hasClass("refreshing") || Waypoint.refreshAll(), g.toggleClass("refreshing")
                })
            }
        })
    }
    ...
    }), t(".menu").on("show.bs.collapse", function () {
        t("body").hasClass("slide-menu") && t("body").addClass("slide-on"), t(".navbar-toggle").removeClass("collapsed")
    }), t(".menu").on("hide.bs.collapse", function () {
        t("body").hasClass("slide-menu") && t("body").removeClass("slide-on"), t(".navbar-toggle").addClass("collapsed")
    }), "on" === oxyThemeData.menuClose && t("body.slide-menu #content").on("click", function () {
        t("body.slide-menu").hasClass("slide-on") && t("#navbar-slide").collapse("hide")
    ...
    for (var y = t(".video-wrapper iframe"), b = 0; b < y.length; b++) y[b].src.indexOf("?") === -1 ? y[b].src += "?wmode=opaque" : y[b].src += "&wmode=opaque";
    t("[data-animation]").each(function () {
        var e = t(this);
        e.on("mouseenter", function () {
            "none" !== e.attr("data-animation") && e.addClass("animated " + e.attr("data-animation"))
        }), e.on("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function (t) {
            e.removeClass("animated " + e.attr("data-animation"))
        })
    });
    var w = t("div.blog-masonry.isotope");
    w.length > 0 && w.infinitescroll({
        ...
        t(e).each(function (e, i) {
            var n = 3,
                o = t(window).width(),
                s = 2,
                a = w.attr("data-padding");
            o < 768 ? (n = w.attr("data-col-xs"), s = 1) : o < 992 ? (n = w.attr("data-col-sm"), s = 1) : o < 1200 ? (n = w.attr("data-col-md"), s = 2) : o > 1200 && (n = w.attr("data-col-lg"), s = 2);
            var r = Math.floor(w.width() / n),
                l = t(this);
            l.hasClass("masonry-wide") ? l.css("width", r * s) : l.css("width", r), l.find(".post-masonry-inner").css("padding", a / 2 + "px")
        }), w.isotope("appended", t(e), function () {
            w.isotope("reLayout", function () {
                Waypoint.refreshAll()
            })
        })
    }), t(".magnific").each(function (e, i) {
        var n = t(this),
            o = "";
        void 0 !== t(this).data("captions") && (o = t(this).data("captions")), n.magnificPopup({
            type: "image",
            removalDelay: 300,
            items: {
                src: n.attr("href"),
        ...
        preloader: !1,
        fixedContentPos: !1
    }), t(".magnific-gallery").each(function (e, i) {
        var n = t(this),
            o = t(this).data("links").split(","),
            s = "";
        void 0 !== t(this).data("captions") && (s = t(this).data("captions").split(","));
        for (var a = [], r = 0; r < o.length; r++) a.push({
            src: o[r],
            title: s[r]
        });
        n.magnificPopup({
        ...
        i.each(function () {
            ...
            void 0 !== e.attr("title") && (i = e.attr("title"));
            var o = "image";
            (e.hasClass("magnific-youtube") || e.hasClass("magnific-vimeo")) && (o = "iframe");
            var s = {
                src: e.attr("href"),
                type: o,
                title: i
    ...
    }), oxyThemeData.hoverMenu.hoverActive === !0 && (t('body:not([class*="oxy-agent"])').length && t(".navbar .dropdown").hover(function () {
    ...
    })), t("body").on("country_to_state_changed", function (e, i) {
    ...
    function g(t, e) {
        var i, n, o, s, a, r, l, c;
        if (1 === e.nodeType) {
            if (vt.hasData(t) && (s = vt.access(t), a = vt.set(e, s), c = s.events)) {
    ...
    function w(t) {
        var e = K,
            i = Wt[t];
        return i || (i = b(t, e), "none" !== i && i || (zt = (zt || J("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = zt[0].contentDocument, e.write(), e.close(), i = b(t, e), zt.detach()), Wt[t] = i), i
    }

    function x(t, e, i) {
        var n, o, s, a, r = t.style;
        return i = i || qt(t), i && (a = i.getPropertyValue(e) || i[e]), i && ("" !== a || J.contains(t.ownerDocument, t) || (a = J.style(t, e)), _t.test(a) && Ht.test(e) && (n = r.width, o = r.minWidth, s = r.maxWidth, r.minWidth = r.maxWidth = r.width = a, a = i.width, r.width = n, r.minWidth = o, r.maxWidth = s)), void 0 !== a ? a + "" : a
    }
    ...
    function A(t, e, i, n, o) {
        for (var s = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, a = 0; s < 4; s += 2) "margin" === i && (a += J.css(t, i + Ct[s], !0, o)), n ? ("content" === i && (a -= J.css(t, "padding" + Ct[s], !0, o)), "margin" !== i && (a -= J.css(t, "border" + Ct[s] + "Width", !0, o))) : (a += J.css(t, "padding" + Ct[s], !0, o), "padding" !== i && (a += J.css(t, "border" + Ct[s] + "Width", !0, o)));
        return a
    }
    ...
    function k(t, e, i) {
        ...
        if (o <= 0 || null == o) {
            if (o = x(t, e, s), (o < 0 || null == o) && (o = t.style[e]), _t.test(o)) return o;
    ...
    function E(t, e) {
        for (var i, n, o, s = [], a = 0, r = t.length; a < r; a++) n = t[a], n.style && (s[a] = vt.get(n, "olddisplay"), i = n.style.display, e ? (s[a] || "none" !== i || (n.style.display = ""), "" === n.style.display && St(n) && (s[a] = vt.access(n, "olddisplay", w(n.nodeName)))) : (o = St(n), "none" === i && o || vt.set(n, "olddisplay", o ? i : J.css(n, "display"))));
    ...
    function M(t, e) {
        ...
        for (e = e ? 1 : 0; n < 4; n += 2 - e) i = Ct[n], o["margin" + i] = o["padding" + i] = t;
        return e && (o.opacity = o.width = t), o
    }

    function L(t, e, i) {
        for (var n, o = (ie[e] || []).concat(ie["*"]), s = 0, a = o.length; s < a; s++)
    ...
    function F(t, e, i) {
        ...
        if (J.isEmptyObject(h)) "inline" === ("none" === c ? w(t.nodeName) : c) && (p.display = c);
            ...
            m ? "hidden" in m && (f = m.hidden) : m = vt.access(t, "fxshow", {}), s && (m.hidden = !f), f ? J(t).show() : d.done(function () {
                J(t).hide()
            }), d.done(function () {
                var e;
                vt.remove(t, "fxshow");
    ...
    function N(t, e, i) {
        var n, o, s = 0,
            ...
            l = function () {
                if (o) return !1;
                for (var e = Xt || j(), i = Math.max(0, c.startTime + c.duration - e), n = i / c.duration || 0, s = 1 - n, a = 0, l = c.tweens.length; a < l; a++) c.tweens[a].run(s);
                return r.notifyWith(t, [c, s, i]), s < 1 && l ? i : (r.resolveWith(t, [c]), !1)
            },
            c = r.promise({
                elem: t,
                props: J.extend({}, e),
            ...
            u = c.props;
        for (I(u, c.opts.specialEasing); s < a; s++)
            if (n = ee[s].call(c, t, u, c.opts)) return n;
    ...
    J.fn = J.prototype = {
        ...
        var t, e, i, n, o, s, a = arguments[0] || {},
            ...
            l = arguments.length,
            c = !1;
        for ("boolean" == typeof a && (c = a, a = arguments[r] || {}, r++), "object" == typeof a || J.isFunction(a) || (a = {}), r === l && (a = this, r--); r < l; r++)
        ...
        each: function (t, e, n) {
            ...
            if (n) {
                if (r)
                    for (; s < a && (o = e.apply(t[s], n), o !== !1); s++);
                else
                    for (s in t)
                        if (o = e.apply(t[s], n), o === !1) break
            } else if (r)
                for (; s < a && (o = e.call(t[s], s, t[s]), o !== !1); s++);
            else
                for (s in t)
        ...
        grep: function (t, e, i) {
            for (var n, o = [], s = 0, a = t.length, r = !i; s < a; s++) n = !e(t[s], s), n !== r && o.push(t[s]);
            return o
        },
        map: function (t, e, n) {
            var o, s = 0,
                ...
                l = [];
            if (r)
                for (; s < a; s++) o = e(t[s], s, n), null != o && l.push(o);
            else
        ...
        proxy: function (t, e) {
            var i, n, o;
            if ("string" == typeof e && (i = t[e], e = t, t = i), J.isFunction(t)) return n = q.call(arguments, 2), o = function () {
    ...
    var ot = function (t) {
            ...
            if (!n && N) {
                ...
                if (x.qsa && (!D || !D.test(t))) {
                    if (p = d = z, f = e, m = 1 !== r && t, 1 === r && "object" !== e.nodeName.toLowerCase()) {
                        for (c = A(t), (d = e.getAttribute("id")) ? p = d.replace(wt, "\\$&") : e.setAttribute("id", p), p = "[id='" + p + "'] ", l = c.length; l--;) c[l] = p + h(c[l]);
        ...
        function g(t, e, i, n, o) {
            for (var s, a = [], r = 0, l = t.length, c = null != e; r < l; r++)(s = t[r]) && (i && !i(s, n, o) || (a.push(s),
                c && e.push(r)));
            return a
        }
            ...
            return o && !o[z] && (o = v(o)), s && !s[z] && (s = v(s, a)), n(function (n, a, r, l) {
                ...
                if (n) {
                    if (s || t) {
                        ...
                        for (u = b.length; u--;)(d = b[u]) && (c = s ? tt(n, d) : h[u]) > -1 && (n[c] = !(a[c] = d))
                    }
            ...
            for (var e, i, n, o = t.length, s = C.relative[t[0].type], a = s || C.relative[" "], r = s ? 1 : 0, l = p(function (t) {
                ...
                if (i = C.relative[t[r].type]) u = [p(f(u), i)];
                    ...
                    if (i = C.filter[t[r].type].apply(null, t[r].matches), i[z]) {
                        for (n = ++r; n < o && !C.relative[t[n].type]; n++);
                        return v(r > 1 && f(u), r > 1 && h(t.slice(0, r - 1).concat({
                            value: " " === t[r - 2].type ? "*" : ""
                        })).replace(lt, "$1"), i, r < n && y(t.slice(r, n)), n < o && y(t = t.slice(n)), n < o && h(t))
                    }
                    u.push(i)
                }
            return f(u)
            ...
            var o = i.length > 0,
                ...
                a = function (n, a, r, l, c) {
                    var u, d, h, p = 0,
                        ...
                        x = b.length;
                    for (c && (P = a !== F && a); f !== x && null != (u = b[f]); f++) {
                        if (s && u) {
                            for (d = 0; h = t[d++];)
                                if (h(u, a, r)) {
                                    l.push(u);
        ...
        var w, x, C, S, T, A, k, E, P, j, M, L, F, I, N, D, B, R, O, z = "sizzle" + 1 * new Date,
            W = t.document,
            H = 0,
            _ = 0,
            q = i(),
        ...
        x = e.support = {}, T = e.isXML = function (t) {
            ...
            return n !== F && 9 === n.nodeType && n.documentElement ? (F = n, I = n.documentElement, i = n.defaultView, i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", St, !1) : i.attachEvent && i.attachEvent("onunload", St)), N = !T(n), x.attributes = o(function (t) {
            ...
            }, B = [], D = [], (x.qsa = vt.test(n.querySelectorAll)) && (o(function (t) {
            ...
            })), (x.matchesSelector = vt.test(R = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector)) && o(function (t) {
                x.disconnectedMatch = R.call(t, "div"), R.call(t, "[s!='']:x"), B.push("!=", at)
            }), D = D.length && new RegExp(D.join("|")), B = B.length && new RegExp(B.join("|")), e = vt.test(I.compareDocumentPosition), O = e || vt.test(I.contains) ? function (t, e) {
                ...
                return i ? i : (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !x.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === W && O(W, t) ? -1 : e === n || e.ownerDocument === W && O(W, e) ? 1 : j ? tt(j, t) - tt(j, e) : 0 : 4 & i ? -1 : 1)
            } : function (t, e) {
                if (t === e) return M = !0, 0;
                var i, o = 0,
                    s = t.parentNode,
                    ...
                    l = [t],
                    c = [e];
                if (!s || !r) return t === n ? -1 : e === n ? 1 : s ? -1 : r ? 1 : j ? tt(j, t) - tt(j, e) : 0;
                if (s === r) return a(t, e);
            ...
            if ((t.ownerDocument || t) !== F && L(t), i = i.replace(dt, "='$1']"), x.matchesSelector && N && (!B || !B.test(i)) && (!D || !D.test(i))) try {
                var n = R.call(t, i);
            ...
            var e, i = [],
                n = 0,
                o = 0;
            if (M = !x.detectDuplicates, j = !x.sortStable && t.slice(0), t.sort(U), M) {
            ...
            preFilter: {
                ...
                PSEUDO: function (t) {
                    var e, i = !t[6] && t[2];
                    return ft.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && ht.test(i) && (e = A(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e), t[2] = i.slice(0, e)), t.slice(0, 3))
                }
            },
            filter: {
                TAG: function (t) {
                ...
                PSEUDO: function (t, i) {
                    ...
                    return s[z] ? s(i) : s.length > 1 ? (o = [t, t, "", i], C.setFilters.hasOwnProperty(t.toLowerCase()) ? n(function (t, e) {
                        for (var n, o = s(t, i), a = o.length; a--;) n = tt(t, o[a]), t[n] = !(e[n] = o[a])
                    }) : function (t) {
                        return s(t, 0, o)
                    }) : s
                }
        ...
        return d.prototype = C.filters = C.pseudos, C.setFilters = new d, A = e.tokenize = function (t, i) {
            ...
            for (r = t, l = [], c = C.preFilter; r;) {
                n && !(o = ct.exec(r)) || (o && (r = r.slice(o[0].length) || r), l.push(s = [])), n = !1, (o = ut.exec(r)) && (n = o.shift(), s.push({
                    value: n,
                    type: o[0].replace(lt, " ")
                }), r = r.slice(n.length));
                for (a in C.filter) !(o = ft[a].exec(r)) || c[a] && !(o = c[a](o)) || (n = o.shift(), s.push({
                    value: n,
                    type: a,
                    matches: o
                }), r = r.slice(n.length));
            ...
            if (i = i || [], 1 === d.length) {
                if (s = d[0] = d[0].slice(0), s.length > 2 && "ID" === (a = s[0]).type && x.getById && 9 === e.nodeType && N && C.relative[s[1].type]) {
                    if (e = (C.find.ID(a.matches[0].replace(xt, Ct), e) || [])[0], !e) return i;
                    c && (e = e.parentNode), t = t.slice(s.shift().value.length)
                }
                for (o = ft.needsContext.test(t) ? 0 : s.length; o-- && (a = s[o], !C.relative[r = a.type]);)
                    if ((l = C.find[r]) && (n = l(a.matches[0].replace(xt, Ct), bt.test(s[0].type) && u(e.parentNode) || e))) {
                        if (s.splice(o, 1), t = n.length && h(s), !t) return Z.apply(i, n), i;
                        break
                    }
            }
            return (c || k(t, d))(n, e, !N, i, bt.test(t) && u(e.parentNode) || e), i
    ...
    var lt, ct = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
        ut = J.fn.init = function (t, e) {
            ...
            if ("string" == typeof t) {
                ...
                if (i[1]) {
                    if (e = e instanceof J ? e[0] : e, J.merge(this, J.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : K, !0)), at.test(i[1]) && J.isPlainObject(e))
    ...
    J.extend({
        ...
        closest: function (t, e) {
            for (var i, n = 0, o = this.length, s = [], a = st.test(t) || "string" != typeof t ? J(t, e || this.context) : 0; n < o; n++)
        ...
        J.fn[t] = function (i, n) {
            ...
            return "Until" !== t.slice(-5) && (n = i), n && "string" == typeof n && (o = J.filter(n, o)), this.length > 1 && (ht[t] || J.unique(o), dt.test(t) && o.reverse()), this.pushStack(o)
        }
    });
    var pt = /\S+/g,
        ft = {};
    J.Callbacks = function (t) {
        ...
        var e, i, n, o, a, r, l = [],
            c = !t.once && [],
            u = function (s) {
                for (e = t.memory && s, i = !0, r = o || 0, o = 0, a = l.length, n = !0; l && r < a; r++)
            ...
            d = {
                ...
                remove: function () {
                    return l && J.each(arguments, function (t, e) {
                        for (var i;
                            (i = J.inArray(e, l, i)) > -1;) l.splice(i, 1), n && (i <= a && a--, i <= r && r--)
                    }), this
                },
                has: function (t) {
        ...
        when: function (t) {
            ...
            if (a > 1)
                for (e = new Array(a), i = new Array(a), n = new Array(a); o < a; o++) s[o] && J.isFunction(s[o].promise) ? s[o].promise().done(c(o, n, s)).fail(l.reject).progress(c(o, i, e)) : --r;
    ...
    J.fn.ready = function (t) {
        ...
        ready: function (t) {
            (t === !0 ? --J.readyWait : J.isReady) || (J.isReady = !0, t !== !0 && --J.readyWait > 0 || (mt.resolveWith(K, [J]), J.fn.triggerHandler && (J(K).triggerHandler("ready"), J(K).off("ready"))))
        }
    }), J.ready.promise = function (e) {
        return mt || (mt = J.Deferred(), "complete" === K.readyState ? setTimeout(J.ready) : (K.addEventListener("DOMContentLoaded", a, !1), t.addEventListener("load", a, !1))), mt.promise(e)
    }, J.ready.promise();
    var gt = J.access = function (t, e, i, n, o, s, a) {
        var r = 0,
            l = t.length,
            c = null == i;
        if ("object" === J.type(i)) {
    ...
    J.extend({
        ...
        promise: function (t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; a--;) i = vt.get(s[a], t + "queueHooks"), i && i.empty && (n++, i.empty.add(r));
    ...
    J.event = {
        ...
        add: function (t, e, i, n, o) {
            var s, a, r, l, c, u, d, h, p, f, m, g = vt.get(t);
            if (g)
                for (i.handler && (s = i, i = s.handler, o = s.selector), i.guid || (i.guid = J.guid++), (l = g.events) || (l = g.events = {}), (a = g.handle) || (a = g.handle = function (e) {
                        return typeof J !== At && J.event.triggered !== e.type ? J.event.dispatch.apply(t, arguments) : void 0
                    }), e = (e || "").match(pt) || [""], c = e.length; c--;) r = jt.exec(e[c]) || [], p = m = r[1], f = (r[2] || "").split(".").sort(), p && (d = J.event.special[p] || {}, p = (o ? d.delegateType : d.bindType) || p, d = J.event.special[p] || {}, u = J.extend({
                    type: p,
                    origType: m,
                    data: n,
                    handler: i,
        ...
        remove: function (t, e, i, n, o) {
            var s, a, r, l, c, u, d, h, p, f, m, g = vt.hasData(t) && vt.get(t);
            if (g && (l = g.events)) {
            ...
            if (r && l.nodeType && (!t.button || "click" !== t.type))
                for (; l !== this; l = l.parentNode || this)
                    if (l.disabled !== !0 || "click" !== t.type) {
                        for (n = [], i = 0; i < r; i++) s = e[i], o = s.selector + " ", void 0 === n[o] && (n[o] = s.needsContext ? J(o, this).index(l) >= 0 : J.find(o, this, null, [l]).length), n[o] && n.push(s);
                        n.length && a.push({
                            elem: l,
                            handlers: n
                        })
        ...
        mouseHooks: {
            ...
            filter: function (t, e) {
                ...
                return null == t.pageX && null != e.clientX && (i = t.target.ownerDocument || K, n = i.documentElement, o = i.body, t.pageX = e.clientX + (n && n.scrollLeft || o && o.scrollLeft || 0) - (n && n.clientLeft || o && o.clientLeft || 0), t.pageY = e.clientY + (n && n.scrollTop || o && o.scrollTop || 0) - (n && n.clientTop || o && o.clientTop || 0)), t.which || void 0 === s || (t.which = 1 & s ? 1 : 2 & s ? 3 : 4 & s ? 2 : 0),
                    t
            }
        },
        fix: function (t) {
            ...
            var e, i, n, o = t.type,
                s = t,
                a = this.fixHooks[o];
            for (a || (this.fixHooks[o] = a = Et.test(o) ? this.mouseHooks : kt.test(o) ? this.keyHooks : {}), n = a.props ? this.props.concat(a.props) : this.props, t = new J.Event(s), e = n.length; e--;) i = n[e], t[i] = s[i];
    ...
    Ot.optgroup = Ot.option, Ot.tbody = Ot.tfoot = Ot.colgroup = Ot.caption = Ot.thead, Ot.th = Ot.td, J.extend({
        clone: function (t, e, i) {
            ...
            if (!(X.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || J.isXMLDoc(t)))
                for (a = v(r), s = v(t), n = 0, o = s.length; n < o; n++) y(s[n], a[n]);
            if (e)
                if (i)
                    for (s = s || v(t), a = a || v(r), n = 0, o = s.length; n < o; n++) g(s[n], a[n]);
                else g(t, r);
            return a = v(r, "script"), a.length > 0 && m(a, !l && v(t, "script")), r
        },
        buildFragment: function (t, e, i, n) {
            for (var o, s, a, r, l, c, u = e.createDocumentFragment(), d = [], h = 0, p = t.length; h < p; h++)
                if (o = t[h], o || 0 === o)
                    if ("object" === J.type(o)) J.merge(d, o.nodeType ? [o] : o);
                    else if (Ft.test(o)) {
                for (s = s || u.appendChild(e.createElement("div")), a = (Lt.exec(o) || ["", ""])[1].toLowerCase(), r = Ot[a] || Ot._default, s.innerHTML = r[1] + o.replace(Mt, "<$1></$2>") + r[2], c = r[0]; c--;) s = s.lastChild;
                J.merge(d, s.childNodes), s = u.firstChild, s.textContent = ""
            } else d.push(e.createTextNode(o));
            for (u.textContent = "", h = 0; o = d[h++];)
                if ((!n || J.inArray(o, n) === -1) && (l = J.contains(o.ownerDocument, o), s = v(u.appendChild(o), "script"), l && m(s), i))
                    for (c = 0; o = s[c++];) Dt.test(o.type || "") && i.push(o);
            return u
        },
        ...
        html: function (t) {
            return gt(this, function (t) {
                ...
                if ("string" == typeof t && !It.test(t) && !Ot[(Lt.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = t.replace(Mt, "<$1></$2>");
                    try {
        ...
        domManip: function (t, e) {
            ...
            var i, n, o, s, a, r, l = 0,
                ...
                h = t[0],
                m = J.isFunction(h);
            if (m || c > 1 && "string" == typeof h && !X.checkClone && Nt.test(h)) return this.each(function (i) {
                var n = u.eq(i);
            ...
            if (c && (i = J.buildFragment(t, this[0].ownerDocument, !1, this), n = i.firstChild, 1 === i.childNodes.length && (i = n), n)) {
                for (o = J.map(v(i, "script"), p), s = o.length; l < c; l++) a = i, l !== d && (a = J.clone(a, !0, !0), s && J.merge(o, v(a, "script"))), e.call(this[l], a, l);
                if (s)
                    for (r = o[o.length - 1].ownerDocument, J.map(o, f), l = 0; l < s; l++) a = o[l], Dt.test(a.type || "") && !vt.access(a, "globalEval") && J.contains(r, a) && (a.src ? J._evalUrl && J._evalUrl(a.src) : J.globalEval(a.textContent.replace(Rt, "")))
            }
            return this
        }
    }), J.each({
        ...
        J.fn[t] = function (t) {
            for (var i, n = [], o = J(t), s = o.length - 1, a = 0; a <= s; a++) i = a === s ? this : this.clone(!0), J(o[a])[e](i), V.apply(n, i.get());
            return this.pushStack(n)
        }
    });
    var zt, Wt = {},
        Ht = /^margin/,
        _t = new RegExp("^(" + xt + ")(?!px)[a-z%]+$", "i"),
        qt = function (e) {
    ...
    J.extend({
        ...
        css: function (t, e, i, n) {
            var o, s, a, r = J.camelCase(e);
            return e = J.cssProps[r] || (J.cssProps[r] = S(t.style, r)), a = J.cssHooks[e] || J.cssHooks[r], a && "get" in a && (o = a.get(t, !0, i)), void 0 === o && (o = x(t, e, n)), "normal" === o && e in Gt && (o = Gt[e]), "" === i || i ? (s = parseFloat(o), i === !0 || J.isNumeric(s) ? s || 0 : o) : o
        }
    }), J.each(["height", "width"], function (t, e) {
        J.cssHooks[e] = {
            get: function (t, i, n) {
                if (i) return $t.test(J.css(t, "display")) && 0 === t.offsetWidth ? J.swap(t, Qt, function () {
                    return k(t, e, n)
                }) : k(t, e, n)
            },
            set: function (t, i, n) {
        ...
        J.cssHooks[t + e] = {
            expand: function (i) {
                for (var n = 0, o = {}, s = "string" == typeof i ? i.split(" ") : [i]; n < 4; n++) o[t + Ct[n] + e] = s[n] || s[n - 2] || s[0];
                return o
            }
        }, Ht.test(t) || (J.cssHooks[t + e].set = T)
    }), J.fn.extend({
        css: function (t, e) {
            return gt(this, function (t, e, i) {
                var n, o, s = {},
                    a = 0;
                if (J.isArray(e)) {
                    for (n = qt(t), o = e.length; a < o; a++) s[e[a]] = J.css(t, e[a], !1, n);
                    return s
                }
        ...
        ie = {
            "*": [function (t, e) {
                var i = this.createTween(t, e),
                    ...
                    a = (J.cssNumber[t] || "px" !== s && +n) && Jt.exec(J.css(i.elem, t)),
                    r = 1,
                    l = 20;
                if (a && a[3] !== s) {
                    s = s || a[3], o = o || [], a = +n || 1;
    ...
    J.Animation = J.extend(N, {
            ...
            var t, e = 0,
                i = J.timers;
            for (Xt = J.now(); e < i.length; e++) t = i[e], t() || i[e] !== t || i.splice(e--, 1);
    ...
    J.fn.extend({
        ...
        attr: function (t, e, i) {
            ...
            if (t && 3 !== s && 8 !== s && 2 !== s) return typeof t.getAttribute === At ? J.prop(t, e, i) : (1 === s && J.isXMLDoc(t) || (e = e.toLowerCase(), n = J.attrHooks[e] || (J.expr.match.bool.test(e) ? oe : ne)), void 0 === i ? n && "get" in n && null !== (o = n.get(t, e)) ? o : (o = J.find.attr(t, e), null == o ? void 0 : o) : null !== i ? n && "set" in n && void 0 !== (o = n.set(t, i, e)) ? o : (t.setAttribute(e, i + ""), i) : void J.removeAttr(t, e))
        },
    ...
    J.fn.extend({
        ...
        toggleClass: function (t, e) {
            ...
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : J.isFunction(t) ? this.each(function (i) {
                ...
                else i !== At && "boolean" !== i || (this.className && vt.set(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : vt.get(this, "__className__") || "")
            })
        },
        hasClass: function (t) {
    ...
    J.extend({
        ...
        ajax: function (t, e) {
            function i(t, e, i, a) {
                var l, u, v, y, w, C = e;
                2 !== b && (b = 2, r && clearTimeout(r), n = void 0, s = a || "", x.readyState = t > 0 ? 4 : 0, l = t >= 200 && t < 300 || 304 === t, i && (y = O(d, x, i)), y = z(d, y, x, l), l ? (d.ifModified && (w = x.getResponseHeader("Last-Modified"), w && (J.lastModified[o] = w), w = x.getResponseHeader("etag"), w && (J.etag[o] = w)), 204 === t || "HEAD" === d.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = y.state, u = y.data, v = y.error, l = !v)) : (v = C, !t && C || (C = "error", t < 0 && (t = 0))), x.status = t, x.statusText = (e || C) + "", l ? f.resolveWith(h, [u, C, x]) : f.rejectWith(h, [x, C, v]), x.statusCode(g), g = void 0, c && p.trigger(l ? "ajaxSuccess" : "ajaxError", [x, d, l ? u : v]), m.fireWith(h, [x, C]), c && (p.trigger("ajaxComplete", [x, d]), --J.active || J.event.trigger("ajaxStop")))
            }
            ...
            if (f.promise(x).complete = m.add, x.success = x.done, x.error = x.fail, d.url = ((t || d.url || xe) + "").replace(de, "").replace(ge, Ce[1] + "//"), d.type = e.method || e.type || d.method || d.type, d.dataTypes = J.trim(d.dataType || "*").toLowerCase().match(pt) || [""], null == d.crossDomain && (l = ve.exec(d.url.toLowerCase()), d.crossDomain = !(!l || l[1] === Ce[1] && l[2] === Ce[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (Ce[3] || ("http:" === Ce[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = J.param(d.data, d.traditional)), B(ye, d, e, x), 2 === b) return x;
            c = J.event && d.global, c && 0 === J.active++ && J.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !me.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (ue.test(o) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = he.test(o) ? o.replace(he, "$1_=" + ce++) : o + (ue.test(o) ? "&" : "?") + "_=" + ce++)), d.ifModified && (J.lastModified[o] && x.setRequestHeader("If-Modified-Since", J.lastModified[o]), J.etag[o] && x.setRequestHeader("If-None-Match", J.etag[o])), (d.data && d.hasContent && d.contentType !== !1 || e.contentType) && x.setRequestHeader("Content-Type", d.contentType), x.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + we + "; q=0.01" : "") : d.accepts["*"]);
    ...
    J.param = function (t, e) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var t = this.type;
                return this.name && !J(this).is(":disabled") && Ee.test(this.nodeName) && !ke.test(t) && (this.checked || !Tt.test(t))
            }).map(function (t, e) {
                var i = J(this).val();
    ...
    }), X.cors = !!Le && "withCredentials" in Le, X.ajax = Le = !!Le, J.ajaxTransport(function (t) {
        var e;
        if (X.cors || Le && !t.crossDomain) return {
            send: function (i, n) {
                var o, s = t.xhr(),
                    a = ++Pe;
                ...
                e = function (t) {
                    return function () {
                        e && (delete je[a], e = s.onload = s.onerror = null, "abort" === t ? s.abort() : "error" === t ? n(s.status, s.statusText) : n(Me[s.status] || s.status, s.statusText, "string" == typeof s.responseText ? {
                            text: s.responseText
                        } : void 0, s.getAllResponseHeaders()))
                    }
                }, s.onload = e(), s.onerror = e("error"), e = je[a] = e("abort");
                try {
    ...
    J.ajaxSetup({
        ...
        jsonpCallback: function () {
            var t = Fe.pop() || J.expando + "_" + ce++;
            return this[t] = !0, t
        }
    }), J.ajaxPrefilter("json jsonp", function (e, i, n) {
        var o, s, a, r = e.jsonp !== !1 && (Ie.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && Ie.test(e.data) && "data");
        if (r || "jsonp" === e.dataTypes[0]) return o = e.jsonpCallback = J.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, r ? e[r] = e[r].replace(Ie, "$1" + o) : e.jsonp !== !1 && (e.url += (ue.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
            return a || J.error(o + " was not called"), a[0]
        }, e.dataTypes[0] = "json", s = t[o], t[o] = function () {
            a = arguments
        }, n.always(function () {
            t[o] = s, e[o] && (e.jsonpCallback = i.jsonpCallback, Fe.push(o)), a && J.isFunction(s) && s(a[0]), a = s = void 0
        }), "script"
    ...
    J.offset = {
        ...
        offset: function (t) {
            ...
            var e, i, n = this[0],
                ...
                s = n && n.ownerDocument;
            if (s) return e = s.documentElement, J.contains(e, n) ? (typeof n.getBoundingClientRect !== At && (o = n.getBoundingClientRect()), i = H(s), {
        ...
        J.cssHooks[e] = C(X.pixelPosition, function (t, i) {
            if (i) return i = x(t, e), _t.test(i) ? J(t).position()[e] + "px" : i
        })
    }), J.each({
        Height: "height",
        Width: "width"
    ...
    return J.noConflict = function (e) {
        return t.$ === J && (t.$ = Re), e && t.jQuery === J && (t.jQuery = Be), J
    }, typeof e === At && (t.jQuery = t.$ = J), J
});
var mejs = mejs || {};
if (mejs.version = "2.15.1", mejs.meIndex = 0, mejs.plugins = {
        silverlight: [{
            version: [3, 0],
        ...
        getScriptPath: function (t) {
            for (var e, i, n, o = 0, s = "", a = "", r = document.getElementsByTagName("script"), l = r.length, c = t.length; o < l; o++) {
                for (i = r[o].src, e = i.lastIndexOf("/"), e > -1 ? (n = i.substring(e + 1), i = i.substring(0, e + 1)) : (n = i, i = ""), e = 0; e < c; e++)
        ...
        secondsToTimeCode: function (t, e, i, n) {
            ...
            var o = Math.floor(t / 3600) % 24,
                ...
                a = Math.floor(t % 60);
            return t = Math.floor((t % 1 * n).toFixed(3)), (e || o > 0 ? (o < 10 ? "0" + o : o) + ":" : "") + (s < 10 ? "0" + s : s) + ":" + (a < 10 ? "0" + a : a) + (i ? ":" + (t < 10 ? "0" + t : t) : "")
        },
        ...
        convertSMPTEtoSeconds: function (t) {
            ...
            t = t.replace(",", ".");
            var e = 0,
                i = t.indexOf(".") != -1 ? t.split(".")[1].length : 0,
                n = 1;
            t = t.split(":").reverse();
        ...
        hasPluginVersion: function (t, e) {
            ...
            return e[1] = e[1] || 0, e[2] = e[2] || 0, i[0] > e[0] || i[0] == e[0] && i[1] > e[1] || i[0] == e[0] && i[1] == e[1] && i[2] >= e[2]
        },
        ...
        setVolume: function (t) {
            null != this.pluginApi && ("youtube" == this.pluginType ? this.pluginApi.setVolume(100 * t) : this.pluginApi.setVolume(t), this.volume = t)
        },
        setMuted: function (t) {
        ...
        createPlugin: function (t, e, i, n, o, s) {
            ...
            switch (t.isVideo ? (r = e.pluginWidth > 0 ? e.pluginWidth : e.videoWidth > 0 ? e.videoWidth : null !== i.getAttribute("width") ? i.getAttribute("width") : e.defaultVideoWidth, l = e.pluginHeight > 0 ? e.pluginHeight : e.videoHeight > 0 ? e.videoHeight : null !== i.getAttribute("height") ? i.getAttribute("height") : e.defaultVideoHeight, r = mejs.Utility.encodeUrl(r), l = mejs.Utility.encodeUrl(l)) : e.enablePluginDebug && (r = 320, l = 240), u.success = e.success, mejs.MediaPluginBridge.registerPluginElement(c, u, i), d.className = "me-plugin", d.id = c + "_container", t.isVideo ? i.parentNode.insertBefore(d, i) : document.body.insertBefore(d, document.body.childNodes[0]), n = ["id=" + c, "isvideo=" + (t.isVideo ? "true" : "false"), "autoplay=" + (n ? "true" : "false"), "preload=" + o, "width=" + r, "startvolume=" + e.startVolume, "timerrate=" + e.timerRate, "flashstreamer=" + e.flashStreamer, "height=" + l, "pseudostreamstart=" + e.pseudoStreamingStartQueryParam], null !== t.url && ("flash" == t.method ? n.push("file=" + mejs.Utility.encodeUrl(t.url)) : n.push("file=" + t.url)), e.enablePluginDebug && n.push("debug=true"), e.enablePluginSmoothing && n.push("smoothing=true"), e.enablePseudoStreaming && n.push("pseudostreaming=true"), s && n.push("controls=true"), e.pluginVars && (n = n.concat(e.pluginVars)), t.method) {
                ...
                case "flash":
                    ...
                    break;
                case "youtube":
                    t.url.lastIndexOf("youtu.be") != -1 ? (t = t.url.substr(t.url.lastIndexOf("/") + 1), t.indexOf("?") != -1 && (t = t.substr(0, t.indexOf("?")))) : t = t.url.substr(t.url.lastIndexOf("=") + 1), youtubeSettings = {
                        container: d,
                        containerId: d.id,
    ...
    }, window.mejs = mejs, window.MediaElement = mejs.MediaElement, function (t, e) {
        var i = {
            locale: {
                language: "",
                strings: {}
    ...
    }(mejs.i18n.locale.strings), "undefined" != typeof jQuery ? mejs.$ = jQuery : "undefined" != typeof ender && (mejs.$ = ender), function (t) {
        mejs.MepDefaults = {
                poster: "",
                ...
                keyActions: [{
                    ...
                    keys: [77],
                    action: function (t) {
                        t.container.find(".mejs-volume-slider").css("display", "block"), t.isVideo && (t.showControls(), t.startControlsTimer()), t.media.muted ? t.setMuted(!1) : t.setMuted(!0)
                    }
                }]
                ...
                onkeydown: function (t, e, i) {
                    if (t.hasFocus && t.options.enableKeyboard)
                        for (var n = 0, o = t.options.keyActions.length; n < o; n++)
                            for (var s = t.options.keyActions[n], a = 0, r = s.keys.length; a < r; a++)
                ...
                var r = i.find(".mejs-time-current"),
                    ...
                    d = function (t) {
                        ...
                        var e = a.offset(),
                            ...
                            n = 0,
                            s = n = 0;
                        o.duration && (t < e.left ? t = e.left : t > i + e.left && (t = i + e.left), s = t - e.left, n = s / i, n = n <= .02 ? 0 : n * o.duration, h && n !== o.currentTime && o.setCurrentTime(n), mejs.MediaFeatures.hasTouch || (c.css("left", s), u.html(mejs.Utility.secondsToTimeCode(n)), c.show()))
                    },
                    h = !1;
                a.bind("mousedown touchstart", function (t) {
                    if (1 === t.which || 0 === t.which) return h = !0, d(t), s.globalBind("mousemove.dur touchmove.dur", function (t) {
                        d(t)
                ...
                if (!mejs.MediaFeatures.isAndroid && !mejs.MediaFeatures.isiOS || !this.options.hideVolumeOnTouchDevices) {
                    var s = this,
                        ...
                        p = function (t) {
                            ...
                            e = Math.max(0, e), e = Math.min(e, 1), h(e), 0 == e ? o.setMuted(!0) : o.setMuted(!1), o.setVolume(e)
                        },
                        f = !1,
                        m = !1;
                    r.hover(function () {
                ...
                if (e.isVideo) {
                    ...
                    if ("native" === s.media.pluginType || !s.options.usePluginFullScreen && !mejs.MediaFeatures.isFirefox) a.click(function () {
                        ...
                        if (function () {
                                ...
                                return "pointerEvents" in t.style && (t.style.pointerEvents = "auto", t.style.pointerEvents = "x", e.appendChild(t), i = i && "auto" === i(t, "").pointerEvents, e.removeChild(t), !!i)
                            ...
                            for (s.globalBind("resize", function () {
                                    h()
                                }), d = 0, n = i.length; d < n; d++) u[i[d]] = t('<div class="mejs-fullscreen-hover" />').appendTo(s.container).mouseover(c).hide();
        ...
        t.extend(mejs.MepDefaults, {
            ...
            buildspeed: function (e, i, n, o) {
                if ("native" == this.media.pluginType) {
                    ...
                    var s;
                    for (t.inArray(this.options.defaultSpeed, this.options.speeds) === -1 && this.options.speeds.push(this.options.defaultSpeed), this.options.speeds.sort(function (t, e) {
                            return parseFloat(e) - parseFloat(t)
                        }), s = 0; s < this.options.speeds.length; s++) n += '<li><input type="radio" name="speed" value="' + this.options.speeds[s] + '" id="' + this.options.speeds[s] + '" ', this.options.speeds[s] == this.options.defaultSpeed ? (n += "checked=true ",
                        n += '/><label for="' + this.options.speeds[s] + '" class="mejs-speed-selected">' + this.options.speeds[s] + "x</label></li>") : n += '/><label for="' + this.options.speeds[s] + '">' + this.options.speeds[s] + "x</label></li>";
        ...
        t.extend(mejs.MepDefaults, {
            ...
            drawChapters: function (e) {
                var i, n, o = this,
                    s = n = 0;
                for (o.chapters.empty(), i = 0; i < e.entries.times.length; i++) n = e.entries.times[i].stop - e.entries.times[i].start, n = Math.floor(n / o.media.duration * 100), (n + s > 100 || i == e.entries.times.length - 1 && n + s < 100) && (n = 100 - s), o.chapters.append(t('<div class="mejs-chapter" rel="' + e.entries.times[i].start + '" style="left: ' + s.toString() + "%;width: " + n.toString() + '%;"><div class="mejs-chapter-block' + (i == e.entries.times.length - 1 ? " mejs-chapter-block-last" : "") + '"><span class="ch-title">' + e.entries.text[i] + '</span><span class="ch-time">' + mejs.Utility.secondsToTimeCode(e.entries.times[i].start) + "&ndash;" + mejs.Utility.secondsToTimeCode(e.entries.times[i].stop) + "</span></div></div>")), s += n;
        ...
        t.extend(mejs.MepDefaults, {
            contextMenuItems: [{
                render: function (t) {
                    return "undefined" == typeof t.enterFullScreen ? null : t.isFullScreen ? mejs.i18n.t("Turn off Fullscreen") : mejs.i18n.t("Go Fullscreen")
                },
                click: function (t) {
                ...
                render: function (t) {
                    return t.media.muted ? mejs.i18n.t("Unmute") : mejs.i18n.t("Mute")
                },
                click: function (t) {
            ...
            buildcontextmenu: function (e) {
                e.contextMenu = t('<div class="mejs-contextmenu"></div>').appendTo(t("body")).hide(), e.container.bind("contextmenu", function (t) {
                    if (e.isContextMenuEnabled) return t.preventDefault(), e.renderContextMenu(t.clientX - 1, t.clientY - 1), !1
            ...
            renderContextMenu: function (e, i) {
                for (var n = this, o = "", s = n.options.contextMenuItems, a = 0, r = s.length; a < r; a++)
    ...
    }(mejs.$), "undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function (t) {
    "use strict";
...
function (t, e, i) {
    ...
    var n, o = t.document,
        ...
        c = function (t) {
            ...
            for (var n = 0, o = l.length; n < o; n++)
                if (e = l[n] + t, "string" == typeof i[e]) return e
        },
        u = c("transform"),
        ...
        h = {
            ...
            csstransforms3d: function () {
                var t = !!c("perspective");
                if (t && "webkitPerspective" in s.style) {
    ...
    if (a)
        for (n in h) a.hasOwnProperty(n) || a.addTest(n, h[n]);
    else {
        a = t.Modernizr = {
            _version: "1.6ish: miniModernizr for Isotope"
        };
        var p, f = " ";
        for (n in h) p = h[n](), a[n] = p, f += " " + (p ? "" : "no-") + n;
        e("html").addClass(f)
    }
    if (a.csstransforms) {
        var m = a.csstransforms3d ? {
            ...
            g = function (t, i, n) {
                var o, s, a = e.data(t, "isoTransform") || {},
                    ...
                    l = {};
                r[i] = n, e.extend(a, r);
                for (o in a) s = a[o], l[o] = m[o](s);
                var c = l.translate || "",
                    d = l.scale || "",
                    h = c + d;
                e.data(t, "isoTransform", a), t.style[u] = h
            };
    ...
    }[d], y = c("transitionDuration"));
    var b, w = e.event,
        x = e.event.handle ? "handle" : "dispatch";
    ...
    e.Isotope.settings = {
        ...
        _create: function (t) {
            ...
            for (var s = 0, a = n.length; s < a; s++) o = n[s], this.originalStyle[o] = i[o] || "";
        ...
        option: function (t) {
            if (e.isPlainObject(t)) {
                ...
                var i;
                for (var n in t) i = "_update" + r(n), this[i] && this[i]()
            }
        },
        ...
        updateSortData: function (t, i) {
            ...
            t.each(function () {
                n = e(this), o = {};
                for (var t in a) i || "original-order" !== t ? o[t] = a[t](n, s) : o[t] = e.data(this, "isotope-sort-data")[t];
        ...
        _sort: function () {
            var t = this.options.sortBy,
                ...
                n = function (n, o) {
                    var s = e(n, t),
                        a = e(o, t);
                    return s === a && "original-order" !== t && (s = e(n, "original-order"), a = e(o, "original-order")), (s > a ? 1 : s < a ? -1 : 0) * i
                };
        ...
        _processStyleQueue: function (t, i) {
            var n, o, s, r, l = this.isLaidOut && this.isUsingJQueryAnimation ? "animate" : "css",
            ...
            if (o = function (t, e) {
                ...
                if (s = !0, r = function () {
                        if (!d) {
                            for (var e, i = 0, n = h.length; i < n; i++) e = h[i], "function" == typeof e && e.call(p.element, t, p);
                            d = !0
                        }
                    }, this.isUsingJQueryAnimation && "animate" === l) c.complete = r, s = !1;
                else if (a.csstransitions) {
                    for (var f, m = 0, g = this.styleQueue[0], b = g && g.$el; !b || !b.length;) {
                        if (f = this.styleQueue[m++], !f) return;
                        b = f.$el
                    }
                    var w = parseFloat(getComputedStyle(b[0])[y]);
                    w > 0 && (o = function (t, e) {
                        e.$el[l](e.style, c).one(v, r)
                    }, s = !1)
                }
            }
            e.each(this.styleQueue, o), s && r(), this.styleQueue = []
        },
        resize: function () {
        ...
        destroy: function () {
            ...
            this.$allAtoms.removeClass(e.hiddenClass + " " + e.itemClass).each(function () {
                var e = this.style;
                e.position = "", e.top = "", e.left = "", e.opacity = "", t && (e[u] = "")
            });
            var i = this.element[0].style;
        ...
        _getSegments: function (t) {
            var e, i = this.options.layoutMode,
                ...
                s = t ? "rows" : "cols",
                a = this.element[o](),
                l = this.options[i] && this.options[i][n] || this.$filteredAtoms["outer" + r(o)](!0) || a;
            e = Math.floor(a / l), e = Math.max(e, 1), this[i][s] = e, this[i][n] = l
        },
            ...
            t.each(function () {
                ...
                if (o = Math.min(o, n.cols), 1 === o) i._masonryPlaceBrick(t, n.colYs);
                    ...
                    var s, a, r = n.cols + 1 - o,
                        l = [];
                    for (a = 0; a < r; a++) s = n.colYs.slice(a, a + o), l[a] = Math.max.apply(Math, s);
                    i._masonryPlaceBrick(t, l)
                }
            })
        },
        _masonryPlaceBrick: function (t, e) {
            for (var i = Math.min.apply(Math, e), n = 0, o = 0, s = e.length; o < s; o++)
                if (e[o] === i) {
                    n = o;
                    break
                }
            ...
            for (o = 0; o < c; o++) this.masonry.colYs[n + o] = l
        },
            ...
            t.each(function () {
                ...
                if (o = Math.min(o, n.rows), 1 === o) i._masonryHorizontalPlaceBrick(t, n.rowXs);
                    ...
                    var s, a, r = n.rows + 1 - o,
                        l = [];
                    for (a = 0; a < r; a++) s = n.rowXs.slice(a, a + o), l[a] = Math.max.apply(Math, s);
        ...
        _masonryHorizontalPlaceBrick: function (t, e) {
            ...
            for (o = 0; o < c; o++) this.masonryHorizontal.rowXs[n + o] = l
        },
        ...
        function n(t) {
            var o = t.target;
            o.src !== r && e.inArray(o, l) === -1 && (l.push(o), --a <= 0 && (setTimeout(i), s.unbind(".imagesLoaded", n)))
        }
        var o = this,
    ...
    e.fn.isotope = function (t, i) {
        if ("string" == typeof t) {
            ...
            this.each(function () {
                ...
                return i ? e.isFunction(i[t]) && "_" !== t.charAt(0) ? void i[t].apply(i, n) : void T("no such method '" + t + "' for isotope instance") : void T("cannot call methods on isotope prior to initialization; attempted to call method '" + t + "'")
            })
        } else this.each(function () {
...
function (t) {
    ...
    w.prototype = {
        ...
        updateItemHTML: function () {
            ...
            if (A("BeforeChange", [e.currItem ? e.currItem.type : "", n]), e.currItem = i, !e.currTemplate[n]) {
                ...
                A("FirstMarkupParse", o), o ? e.currTemplate[n] = t(o) : e.currTemplate[n] = !0
            }
    ...
    var j, M, L, F = "inline",
        I = function () {
            L && (M.after(L.addClass(j)).detach(), L = null)
        };
            ...
            getInline: function (i, n) {
                if (I(), i.src) {
                    ...
                    if (s.length) {
                        ...
                        a && a.tagName && (M || (j = o.hiddenClass, M = T(j), j = "mfp-" + j), L = s.after(M).detach().removeClass(j)), e.updateStatus("ready")
    ...
    t.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            getImage: function (i, n) {
                var o = 0,
                    s = function () {
                        i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, A("ImageLoadComplete")) : (o++, o < 200 ? setTimeout(s, 100) : a()))
                    },
                    a = function () {
...
function () {
        ...
        return n.defaults = {
            ...
            return r && (s /= 2), a.offset = i(a.offset), a.over = i(a.over), this.each(function () {
                ...
                if (null !== o) {
                    ...
                    var m = t.isFunction(a.offset) && a.offset(d, p) || a.offset;
                    t.each(a.axis.split(""), function (t, e) {
                        var i = "x" === e ? "Left" : "Top",
                            ...
                            g = h[s](),
                            v = n.max(d, e);
                        if (c) f[s] = c[o] + (u ? 0 : g - h.offset()[o]), a.margin && (f[s] -= parseInt(p.css("margin" + i), 10) || 0, f[s] -= parseInt(p.css("border" + i + "Width"), 10) || 0), f[s] += m[o] || 0, a.over[o] && (f[s] += p["x" === e ? "width" : "height"]() * a.over[o]);
                        else {
                            var y = p[o];
                            f[s] = y.slice && "%" === y.slice(-1) ? parseFloat(y) / 100 * v : y
                        }
                        a.limit && /^\d+$/.test(f[s]) && (f[s] = f[s] <= 0 ? 0 : Math.min(f[s], v)), !t && a.axis.length > 1 && (g === f[s] ? f = {} : r && (l(a.onAfterFirst), f = {}))
                    }), l(a.onAfter)
                }
            })
        }, n.max = function (i, n) {
                ...
                if (n)
                    for (var s = 0, a = n.length; s < a; ++s) {
                        var r = n[s].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/),
                            ...
                            d = r[3] || "",
                            h = null;
                        r = r[2], l.hasOwnProperty(r) && (h = l[r], h = Number(t[h])), null !== h && ("!" === u && (h = o(d, h)), "" === u && h < 10 && (h = "0" + h.toString()), e = e.replace(c, h.toString()))
                    }
                return e = e.replace(/%%/, "%")
            }
        }
        ...
        t.extend(c.prototype, {
            ...
            return this.each(function () {
                ...
                if (void 0 !== i) {
                    var n = s[i],
                        o = e[0];
                    c.prototype.hasOwnProperty(o) ? n[o].apply(n, e.slice(1)) : null === String(o).match(/^[$A-Z_][0-9A-Z_$]*$/i) ? (n.setFinalDate.call(n, o), n.start()) : t.error("Method %s does not exist on jQuery.countdown".replace(/\%s/gi, o))
    ...
    function (t) {
        ...
        t.flexslider = function (i, n) {
            ...
            t.data(i, "flexslider", o), g = {
                ...
                asNav: {
                    setup: function () {
                        o.asNav = !0, o.animatingTo = Math.floor(o.currentSlide / o.move), o.currentItem = o.currentSlide, o.slides.removeClass(a + "active-slide").eq(o.currentItem).addClass(a + "active-slide"), r ? (i._slider = o, o.slides.each(function () {
                            ...
                            s <= 0 && i.hasClass(a + "active-slide") ? o.flexAnimate(o.getTarget("prev"), !0) : t(o.vars.asNavFor).data("flexslider").animating || i.hasClass(a + "active-slide") || (o.direction = o.currentItem < n ? "next" : "prev", o.flexAnimate(n, o.vars.pauseOnAction, !1, !0, !0))
                        })
                    }
                },
                controlNav: {
                    ...
                    setupPaging: function () {
                        var e, i, n = "thumbnails" === o.vars.controlNav ? "control-thumbs" : "control-paging",
                            s = 1;
                        if (o.controlNavScaffold = t('<ol class="' + a + "control-nav " + a + n + '"></ol>'), o.pagingCount > 1)
                ...
                directionNav: {
                    setup: function () {
                        ...
                        o.customDirectionNav ? o.directionNav = o.customDirectionNav : o.controlsContainer ? (t(o.controlsContainer).append(e), o.directionNav = t("." + a + "direction-nav li a", o.controlsContainer)) : (o.append(e), o.directionNav = t("." + a + "direction-nav li a", o)), g.directionNav.update(), o.directionNav.bind(c, function (e) {
                            e.preventDefault();
                            var i;
                            "" !== u && u !== e.type || (i = t(this).hasClass(a + "next") ? o.getTarget("next") : o.getTarget("prev"), o.flexAnimate(i, o.vars.pauseOnAction)), "" === u && (u = e.type), g.setToClearWatchedEvent()
                        })
                    },
                    update: function () {
                        var t = a + "disabled";
                ...
                touch: function () {
                    function t(t) {
                        t.stopPropagation(), o.animating ? t.preventDefault() : (o.pause(), i._gesture.addPointer(t.pointerId), C = 0, c = d ? o.h : o.w, m = Number(new Date), l = p && h && o.animatingTo === o.last ? 0 : p && h ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : p && o.currentSlide === o.last ? o.limit : p ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : h ? (o.last - o.currentSlide + o.cloneOffset) * c : (o.currentSlide + o.cloneOffset) * c)
                    }
                    ...
                    function e(t) {
                        ...
                        if (e) {
                            var n = -t.translationX,
                                o = -t.translationY;
                            return C += d ? o : n, u = C, b = d ? Math.abs(C) < Math.abs(-n) : Math.abs(C) < Math.abs(-o), t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function () {
                                i._gesture.stop()
                            }) : void((!b || Number(new Date) - m > 500) && (t.preventDefault(), !f && e.transitions && (e.vars.animationLoop || (u = C / (0 === e.currentSlide && C < 0 || e.currentSlide === e.last && C > 0 ? Math.abs(C) / c + 2 : 1)), e.setProps(l + u, "setTouch"))))
                        }
                    }
                    ...
                    function n(t) {
                        ...
                        if (e) {
                            ...
                            s = null, a = null, u = null, l = null, C = 0
                        }
                    }
                    var s, a, l, c, u, m, g, v, y, b = !1,
                        w = 0,
                        x = 0,
                        C = 0;
                    r ? (i.style.msTouchAction = "none", i._gesture = new MSGesture, i._gesture.target = i, i.addEventListener("MSPointerDown", t, !1), i._slider = o, i.addEventListener("MSGestureChange", e, !1), i.addEventListener("MSGestureEnd", n, !1)) : (g = function (t) {
                        o.animating ? t.preventDefault() : (window.navigator.msPointerEnabled || 1 === t.touches.length) && (o.pause(), c = d ? o.h : o.w, m = Number(new Date), w = t.touches[0].pageX, x = t.touches[0].pageY, l = p && h && o.animatingTo === o.last ? 0 : p && h ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : p && o.currentSlide === o.last ? o.limit : p ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : h ? (o.last - o.currentSlide + o.cloneOffset) * c : (o.currentSlide + o.cloneOffset) * c, s = d ? x : w, a = d ? w : x, i.addEventListener("touchmove", v, !1), i.addEventListener("touchend", y, !1))
                    }, v = function (t) {
                        w = t.touches[0].pageX, x = t.touches[0].pageY, u = d ? s - x : s - w, b = d ? Math.abs(u) < Math.abs(w - a) : Math.abs(u) < Math.abs(x - a);
                        var e = 500;
                        (!b || Number(new Date) - m > e) && (t.preventDefault(), !f && o.transitions && (o.vars.animationLoop || (u /= 0 === o.currentSlide && u < 0 || o.currentSlide === o.last && u > 0 ? Math.abs(u) / c + 2 : 1), o.setProps(l + u, "setTouch")))
                    }, y = function (t) {
                        if (i.removeEventListener("touchmove", v, !1), o.animatingTo === o.currentSlide && !b && null !== u) {
                            var e = h ? -u : u,
                                n = e > 0 ? o.getTarget("next") : o.getTarget("prev");
                            o.canAdvance(n) && (Number(new Date) - m < 550 && Math.abs(e) > 50 || Math.abs(e) > c / 2) ? o.flexAnimate(n, o.vars.pauseOnAction) : f || o.flexAnimate(o.currentSlide, o.vars.pauseOnAction, !0)
                        }
                        i.removeEventListener("touchend", y, !1), s = null, a = null, u = null, l = null
                ...
                if (o.vars.animationLoop || e === o.currentSlide || (o.direction = e > o.currentSlide ? "next" : "prev"), m && 1 === o.pagingCount && (o.direction = o.currentItem < e ? "next" : "prev"), !o.animating && (o.canAdvance(e, r) || n) && o.is(":visible")) {
                    if (m && s) {
                ...
                p || o.slides.removeClass(a + "active-slide").eq(o.currentSlide).addClass(a + "active-slide"), o.vars.init(o)
            }, o.doMath = function () {
            ...
            if (void 0 === e && (e = {}), "object" == typeof e) return this.each(function () {
                var i = t(this),
                    ...
                    o = i.find(n);
                1 === o.length && e.allowOneSlide === !1 || 0 === o.length ? (o.fadeIn(400),
                    e.start && e.start(i)) : void 0 === i.data("flexslider") && new t.flexslider(this, e)
            });
    ...
    function () {
        var t, e, i, n, o, s, a, r, l, c, u, d, h, p, f, m, g, v, y, b, w, x, C, S, T, A, k, E, P, j, M, L, F = [].slice;
        g = '<span class="odometer-value"></span>', p = '<span class="odometer-ribbon"><span class="odometer-ribbon-inner">' + g + "</span></span>", n = '<span class="odometer-digit"><span class="odometer-digit-spacer">8</span><span class="odometer-digit-inner">' + p + "</span></span>", a = '<span class="odometer-formatting-mark"></span>', i = "(,ddd).dd", r = /^\(?([^)]*)\)?(?:(.)(d+))?$/, l = 30, s = 2e3, t = 20, c = 2, o = .5, u = 1e3 / l, e = 1e3 / t, f = "transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd", T = document.createElement("div").style, m = null != T.transition || null != T.webkitTransition || null != T.mozTransition || null != T.oTransition, C = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, d = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, y = function (t) {
            ...
            if (!P && null != window.jQuery) {
                for (P = !0, n = ["html", "text"], o = [], e = 0, i = n.length; i > e; e++) t = n[e], o.push(function (t) {
                    var e;
            ...
            return t.prototype.renderInside = function () {
                ...
                if (n = +t - this.value) return s = o = w(), i = this.value, (a = function () {
                    var l, c, u;
                ...
                var e, i, n, s, a, r, l, c, u, d, h, p, f, m, g, y, b, w, x, C, S, T, A, E, P, j, M;
                if (y = this.value, c = this.getFractionalDigitCount(y, t), c && (t *= Math.pow(10, c), y *= Math.pow(10, c)), n = t - y) {
                    ...
                    for (this.resetDigits(), j = a.reverse(), h = S = 0, A = j.length; A > S; h = ++S)
                        for (d = j[h], this.digits[h] || this.addDigit(" ", h >= c), null == (w = this.ribbons)[h] && (w[h] = this.digits[h].querySelector(".odometer-ribbon-inner")), this.ribbons[h].innerHTML = "", 0 > n && (d = d.reverse()), f = P = 0, E = d.length; E > P; f = ++P) u = d[f], g = document.createElement("div"), g.className = "odometer-value", g.innerHTML = u, this.ribbons[h].appendChild(g), f === d.length - 1 && v(g, "odometer-last-value"), 0 === f && v(g, "odometer-first-value");
        ...
        }, null != (null != (L = document.documentElement) ? L.doScroll : void 0) && null != document.createEventObject ? (j = document.onreadystatechange, document.onreadystatechange = function () {
            return "complete" === document.readyState && h.options.auto !== !1 && h.init(), null != j ? j.apply(this, arguments) : void 0
    ...
    function () {
        ...
        var n = i.helpers = {},
            ...
            A = (n.animationLoop = function (t, e, i, n, o, s) {
                var a = 0,
                    r = C[i] || C.linear,
                    l = function () {
                        a++;
            ...
            P = n.getMaximumWidth = function (t) {
                var e = t.parentNode;
        ...
        i.instances = {}, i.Type = function (t, e, n) {
            ...
            draw: function () {
                ...
                if (t.fillStyle = this.fillColor, this.custom) this.custom(this);
                    ...
                    N(t, s, a, i, n, this.cornerRadius), t.fill(), t.fillStyle = this.textColor, t.textAlign = "center", t.textBaseline = "middle", t.fillText(this.text, s + i / 2, a + n / 2)
                }
            }
            ...
            calculateXLabelRotation: function () {
                ...
                if (this.xScalePaddingRight = n / 2 + 3, this.xScalePaddingLeft = i / 2 > this.yLabelWidth + 10 ? i / 2 : this.yLabelWidth + 10, this.xLabelRotation = 0, this.display) {
                    ...
                    for (var a = Math.floor(this.calculateX(1) - this.calculateX(0)) - 6; this.xLabelWidth > a && 0 === this.xLabelRotation || this.xLabelWidth > a && this.xLabelRotation <= 90 && this.xLabelRotation > 0;) o = Math.cos(y(this.xLabelRotation)), t = o * i, e = o * n, t + this.fontSize / 2 > this.yLabelWidth + 8 && (this.xScalePaddingLeft = t + this.fontSize / 2), this.xScalePaddingRight = this.fontSize / 2,
                        this.xLabelRotation++, this.xLabelWidth = o * s;
            ...
            setScaleSize: function () {
                var t, e, i, n, o, s, a, r, l, c, u, d, h = g([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]),
                    p = this.width,
                    m = 0;
                for (this.ctx.font = F(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), e = 0; e < this.valuesCount; e++) t = this.getPointPosition(e, h), i = this.ctx.measureText(x(this.templateString, {
                    value: this.labels[e]
    ...
    function (t, e) {
        ...
        function n(e) {
            ...
            return e = e.toLowerCase(), f(l, function (t, o) {
                var s, a = o.re.exec(e),
                    r = a && o.parse(a),
                    l = o.space || "rgba";
                if (r) return s = i[l](r), i[u[l].cache] = s[u[l].cache], n = i._rgba = s._rgba, !1
        ...
        p.style.cssText = "background-color:rgba(1,1,1,.5)", h.rgba = p.style.backgroundColor.indexOf("rgba") > -1, f(u, function (t, e) {
            ...
            var e, i, n = t[0] / 255,
                ...
                u = r + l,
                d = .5 * u;
            return e = l === r ? 0 : n === r ? 60 * (o - s) / c + 360 : o === r ? 60 * (s - n) / c + 120 : 60 * (n - o) / c + 240, i = 0 === c ? 0 : d <= .5 ? c / u : c / (2 - u), [Math.round(e) % 360, i, d, null == a ? 1 : a]
    ...
    function (t, e, i) {
        ...
        function n(i) {
            if (o = e.documentElement, s = e.body, V(), rt = this, i = i || {}, ht = i.constants || {}, i.easing)
                for (var n in i.easing) G[n] = i.easing[n];
            bt = i.edgeStrategy || "set", ut = {
                beforerender: i.beforerender,
                render: i.render,
                keyframe: i.keyframe
            }, dt = i.forceHeight !== !1, dt && (Bt = i.scale || 1), pt = i.mobileDeceleration || T, mt = i.smoothScrolling !== !1, gt = i.smoothScrollingDuration || k, vt = {
            ...
            })(), $t ? (ct = e.getElementById(i.skrollrBody || A), ct && at(), Y(), Mt(o, [y, x], [b])) : Mt(o, [y, w], [b]), rt.refresh(), Ct(t, "resize orientationchange", function () {
                var t = o.clientWidth,
                    e = o.clientHeight;
                e === Ht && t === Wt || (Ht = e, Wt = t, _t = !0)
            });
            var a = U();
            return function r() {
                Z(), xt = a(r)
        ...
        n.prototype.refresh = function (t) {
            var n, o, s = !1;
            for (t === i ? (s = !0, lt = [], qt = 0, t = e.getElementsByTagName("*")) : t.length === i && (t = [t]), n = 0, o = t.length; n < o; n++) {
                var a = t[n],
                    r = a,
                    l = [],
                    c = mt,
                ...
                if (s && L in a && delete a[L], a.attributes) {
                    for (var h = 0, p = a.attributes.length; h < p; h++) {
                                ...
                                if ("data-edge-strategy" !== m.name)
                                    if ("data-emit-events" !== m.name) {
                                        ...
                                        if (null !== g) {
                                            ...
                                            var w = g[3],
                                                x = g[4] || w;
                                            w && w !== E && w !== P ? (v.mode = "relative", v.anchors = [w, x]) : (v.mode = "absolute", w === P ? v.isEnd = !0 : v.isPercentage || (v.offset = v.offset * Bt))
                                        }
                                    } else d = !0;
                        else u = m.value;
                        else c = "off" !== m.value;
                    ...
                    if (l.length) {
                        var C, S, T;
                        !s && L in a ? (T = a[L], C = lt[T].styleAttr, S = lt[T].classAttr) : (T = a[L] = qt++, C = a.style.cssText, S = jt(a)), lt[T] = {
                            element: a,
                            styleAttr: C,
                            classAttr: S,
                            anchorTarget: r,
            ...
            var n = o.clientHeight,
                ...
                a = s.top,
                r = s.bottom - s.top;
            return e === M ? a -= n : e === j && (a -= n / 2), i === M ? a += r : i === j && (a += r / 2), a += rt.getScrollTop(), a + .5 | 0
            ...
            }, ft.topDiff || (ft.done && ft.done.call(rt, !1), ft = i), rt
        }, n.prototype.stopAnimateTo = function () {
            ft && ft.done && ft.done.call(rt, !0), ft = i
        }, n.prototype.isAnimatingTo = function () {
            return !!ft
        }, n.prototype.isMobile = function () {
            return $t
        }, n.prototype.setScrollTop = function (e, i) {
            return yt = i === !0, $t ? Vt = l.min(l.max(e, 0), Dt) : t.scrollTo(0, e), rt
        }, n.prototype.getScrollTop = function () {
            return $t ? Vt : t.pageYOffset || o.scrollTop || s.scrollTop || 0
        }, n.prototype.getMaxScrollTop = function () {
            return Dt
        }, n.prototype.on = function (t, e) {
            return ut[t] = e, rt
        }, n.prototype.off = function (t) {
            return delete ut[t], rt
        }, n.prototype.destroy = function () {
            var t = Q();
            t(xt), Tt(), Mt(o, [b], [y, w, x]);
            for (var e = 0, n = lt.length; e < n; e++) st(lt[e].element);
            o.style.overflow = s.style.overflow = "", o.style.height = s.style.height = "", ct && a.setStyle(ct, "transform", "none"), rt = i, ct = i, ut = i, dt = i, Dt = 0, Bt = 1, ht = i, pt = i, Rt = "down", Ot = -1, Wt = 0, Ht = 0, _t = !1, ft = i, mt = i, gt = i, vt = i, yt = i, qt = 0, bt = i, $t = !1, Vt = 0, wt = i
        };
        var Y = function () {
                var n, a, r, c, f, m, g, v, y, b, w, x;
                Ct(o, [u, d, h, p].join(" "), function (t) {
                    ...
                    switch (f = o.clientY, m = o.clientX, b = t.timeStamp, F.test(c.tagName) || t.preventDefault(), t.type) {
                        case u:
                            n && n.blur(), rt.stopAnimateTo(), n = c, a = g = f, r = m, y = b;
                            break;
                        case d:
                            F.test(c.tagName) && e.activeElement !== c && t.preventDefault(), v = f - g, x = b - w, rt.setScrollTop(Vt - v, !0), g = f, w = b;
                            break;
                        default:
                        case h:
                        case p:
                            ...
                            var k = l.abs(A / pt),
                                ...
                                P = rt.getScrollTop() - E,
                                j = 0;
                            P > Dt ? (j = (Dt - P) / E, P = Dt) : P < 0 && (j = -P / E, P = 0), k *= 1 - j, rt.animateTo(P + .5 | 0, {
                                easing: "outCubic",
                                duration: k
                            })
                    }
            ...
            X = function () {
                var t, e, i, n, s, a, r, c, u, d, h, p = o.clientHeight,
                    f = Et();
                for (c = 0, u = lt.length; c < u; c++)
                    for (t = lt[c], e = t.element, i = t.anchorTarget, n = t.keyFrames, s = 0, a = n.length; s < a; s++) r = n[s], d = r.offset, h = f[r.constant] || 0, r.frame = d, r.isPercentage && (d *= p, r.frame = d), "relative" === r.mode && (st(e), r.frame = rt.relativeToAbsolute(i, r.anchors[0], r.anchors[1]) - d, st(e, !0)), r.frame += h, dt && !r.isEnd && r.frame > Dt && (Dt = r.frame);
                for (Dt = l.max(Dt, Pt()), c = 0, u = lt.length; c < u; c++) {
                    for (t = lt[c], n = t.keyFrames, s = 0, a = n.length; s < a; s++) r = n[s], h = f[r.constant] || 0, r.isEnd && (r.frame = Dt - r.offset + h);
                    t.keyFrames.sort(Nt)
                }
            },
            K = function (t, e) {
                for (var i = 0, n = lt.length; i < n; i++) {
                    var o, s, l = lt[i],
                        ...
                        S = l.lastFrameIndex;
                    if (b || w) {
                        if (b && l.edge === -1 || w && 1 === l.edge) continue;
                        switch (b ? (Mt(c, [m], [v, g]), C && S > -1 && (At(c, p.eventType, Rt), l.lastFrameIndex = -1)) : (Mt(c, [v], [m, g]), C && S < h && (At(c, y.eventType, Rt), l.lastFrameIndex = h)), l.edge = b ? -1 : 1, l.edgeStrategy) {
                            case "reset":
                                st(c);
                                continue;
                            case "ease":
                            ...
                            case "set":
                                var T = x.props;
                                for (o in T) r.call(T, o) && (s = ot(T[o].value), 0 === o.indexOf("@") ? c.setAttribute(o.substr(1), s) : a.setStyle(c, o, s));
                                continue
                        }
                    } else 0 !== l.edge && (Mt(c, [f, g], [m, v]), l.edge = 0);
                    for (var A = 0; A < h - 1; A++)
                        if (u >= d[A].frame && u <= d[A + 1].frame) {
                            ...
                            for (o in k.props)
                                if (r.call(k.props, o)) {
                                    var P = (u - k.frame) / (E.frame - k.frame);
                                    P = k.props[o].easing(P), s = nt(k.props[o].value, E.props[o].value, P), s = ot(s), 0 === o.indexOf("@") ? c.setAttribute(o.substr(1), s) : a.setStyle(c, o, s)
                                }
                            C && S !== A && ("down" === Rt ? At(c, k.eventType, Rt) : At(c, E.eventType, Rt), l.lastFrameIndex = A);
                            break
                        }
                }
            },
            Z = function () {
                ...
                var t, e, n = rt.getScrollTop(),
                    o = It();
                if (ft) o >= ft.endTime ? (n = ft.targetTop, t = ft.done, ft = i) : (e = ft.easing((o - ft.startTime) / ft.duration), n = ft.startTop + e * ft.topDiff | 0), rt.setScrollTop(n, !0);
                else if (!yt) {
                    ...
                    s && (vt = {
                        ...
                        startTime: zt,
                        endTime: zt + gt
                    }), o <= vt.endTime && (e = G.sqrt((o - vt.startTime) / gt), n = vt.startTop + e * vt.topDiff | 0)
                }
                if (yt || Ot !== n) {
                    Rt = n > Ot ? "down" : n < Ot ? "up" : Rt, yt = !1;
                    var r = {
                            curTop: n,
                            lastTop: Ot,
                            maxTop: Dt,
                    ...
                    l !== !1 && (K(n, rt.getScrollTop()), $t && ct && a.setStyle(ct, "transform", "translate(0, " + -Vt + "px) " + wt), Ot = n, ut.render && ut.render.call(rt, r)), t && t.call(rt, !1)
                }
                zt = o
            },
            J = function (t) {
                for (var e = 0, i = t.keyFrames.length; e < i; e++) {
                    for (var n, o, s, a, r = t.keyFrames[e], l = {}; null !== (a = D.exec(r.props));) s = a[1], o = a[2], n = s.match(B), null !== n ? (s = n[1], n = n[2]) : n = C, o = o.indexOf("!") ? tt(o) : [o.slice(1)], l[s] = {
                        value: o,
                        easing: G[n]
                    };
                    r.props = l
            ...
            nt = function (t, e, i) {
                ...
                var s = [t[0]];
                for (n = 1; n < o; n++) s[n] = t[n] + (e[n] - t[n]) * i;
                return s
            },
            ot = function (t) {
                var e = 1;
            ...
            st = function (t, e) {
                t = [].concat(t);
                for (var i, n, o = 0, s = t.length; o < s; o++) n = t[o], i = lt[n[L]], i && (e ? (n.style.cssText = i.dirtyStyleAttr, Mt(n, i.dirtyClassAttr)) : (i.dirtyStyleAttr = n.style.cssText, i.dirtyClassAttr = jt(n), n.style.cssText = i.styleAttr, Mt(n, i.classAttr)))
            },
            at = function () {
                wt = "translateZ(0)", a.setStyle(ct, "transform", wt);
                var t = c(ct),
        ...
        a.setStyle = function (t, e, i) {
            var n = t.style;
            if (e = e.replace(R, O).replace("-", ""), "zIndex" === e) isNaN(i) ? n[e] = i : n[e] = "" + (0 | i);
            else if ("float" === e) n.styleFloat = n.cssFloat = i;
            else try {
                q && (n[q + e.slice(0, 1).toUpperCase() + e.slice(1)] = i), n[e] = i
            } catch (o) {}
        };
        var rt, lt, ct, ut, dt, ht, pt, ft, mt, gt, vt, yt, bt, wt, xt, Ct = a.addEvent = function (e, i, n) {
                var o = function (e) {
                ...
                i = i.split(" ");
                for (var s, a = 0, r = i.length; a < r; a++) s = i[a], e.addEventListener ? e.addEventListener(s, n, !1) : e.attachEvent("on" + s, o), Ut.push({
                    element: e,
                    name: s,
                    listener: n
                })
            },
            St = a.removeEvent = function (t, e, i) {
                e = e.split(" ");
                for (var n = 0, o = e.length; n < o; n++) t.removeEventListener ? t.removeEventListener(e[n], i, !1) : t.detachEvent("on" + e[n], i)
            },
            Tt = function () {
            ...
            kt = function () {
                ...
                Dt = 0, dt && !$t && (s.style.height = ""), X(), dt && !$t && (s.style.height = Dt + o.clientHeight + "px"), $t ? rt.setScrollTop(l.min(rt.getScrollTop(), Dt)) : rt.setScrollTop(t, !0), yt = !0
            },
            Et = function () {
            ...
            Mt = function (e, n, o) {
                ...
                for (var a = e[s], r = 0, l = o.length; r < l; r++) a = Ft(a).replace(Ft(o[r]), " ");
                a = Lt(a);
                for (var c = 0, u = n.length; c < u; c++) Ft(a).indexOf(Ft(n[c])) === -1 && (a += " " + n[c]);
                e[s] = Lt(a)
            },
            Lt = function (t) {
                return t.replace(I, "")
    ...
    function (t, e) {
        ...
        function i(t, e, i, n, o, s, a) {
            ...
            if (a = "number" == typeof a ? a : 0, t.css(i, n + s), r = t.width(), r >= e) {
                ...
                return {
                    match: "estimate",
                    size: parseFloat((parseFloat(n) - ("word-spacing" === i && a && c < l ? 0 : o)).toFixed(3))
                }
            }
            return r
        }
        ...
        function n(t, n, o, s, a) {
            ...
            return n.css("float", "left").each(function () {
                ...
                n = parseInt(o / m, 10) - p;
                t: for (var g = 0, v = u.length; g < v; g++) e: for (var y = 1, b = 10; y <= b; y++) {
                    if (n + y * u[g] > s) {
                        n = s;
                        break t
                    }
                ...
                h.push(o / n), n > s ? (c.push(s), d.push(!1)) : a && n < a ? (c.push(a), d.push(!0)) : (c.push(n), d.push(!1))
            }).each(function (t) {
                var n, s = e(this),
                    a = 0,
                    r = 1;
        ...
        var o = 0,
            ...
            l = {
                ...
                supports: {
                    wholeNumberFontSizeOnly: function () {
                        ...
                        var i = e("<div/>").css({
                            ...
                            n = t.getComputedStyle(i[0], null),
                            o = n && "14px" === n.getPropertyValue("font-size");
                        return i.remove(), o
                    }()
                },
                init: function () {
                ...
                bindResize: function (i, n) {
                    var o;
                    e(t).unbind(i).bind(i, function () {
                        o && clearTimeout(o), o = setTimeout(n, 100)
                    })
                },
                ...
                generateCss: function (t, e, i, n) {
                    var o = [];
                    l.clearCss(t);
                    for (var s = 0, a = e.length; s < a; s++) o.push("#" + t + " ." + l.LINE_CLASS_PREFIX + s + " {" + (n[s] ? " white-space: normal;" : "") + (e[s] ? " font-size: " + e[s] + "px;" : "") + (i[s] ? " word-spacing: " + i[s] + "px;" : "") + "}");
...
window.paceOptions = {
        ...
        window.self !== window.top ? t(window).on("load", function () {
            oxyThemeScripts(t)
        }) : oxyThemeScripts(t)
    }), jQuery(document).ready(function (t) {
        function e() {
            n(t(".cd-headline.letters").find("b")), o(t(".cd-headline"))
        }
        ...
        function o(e) {
            ...
            e.each(function () {
                ...
                if (e.hasClass("loading-bar")) i = h, setTimeout(function () {
                    ...
                    var a = e.find(".cd-words-wrapper b"),
                        r = 0;
                    a.each(function () {
                        var e = t(this).width();
                        e > r && (r = e)
        ...
        function s(t) {
            ...
            if (t.parents(".cd-headline").hasClass("type")) {
                ...
                r(t.find("i").eq(0), t, n, f), l(e.find("i").eq(0), e, n, f)
            ...
            }, p)) : (u(t, e), setTimeout(function () {
                s(e)
            }, d))
        }

        function a(t, e) {
            t.parents(".cd-headline").hasClass("type") ? (l(t.find("i").eq(0), t, !1, e), t.addClass("is-visible").removeClass("is-hidden")) : t.parents(".cd-headline").hasClass("clip") && t.parents(".cd-words-wrapper").animate({
                width: t.width() + 10
            }, y, function () {
                setTimeout(function () {
                    s(t)
        ...
        function r(e, i, n, o) {
            if (e.removeClass("in").addClass("out"), e.is(":last-child") ? n && setTimeout(function () {
                    ...
                    r(e.next(), i, n, o)
                }, o), e.is(":last-child") && t("html").hasClass("no-csstransitions")) {
                var a = c(i);
                u(i, a)
            }
        }
    ...
    function () {
        var t, e, i, n, o, s, a, r, l, c, u, d, h, p, f, m, g, v, y, b, w, x, C, S, T, A, k, E, P, j, M, L, F, I, N, D, B, R, O, z, W, H, _, q, $, V, U, Q, G, Y = [].slice,
            X = {}.hasOwnProperty,
            K = function (t, e) {
                function i() {
                    this.constructor = t
        ...
        for (w = {
                ...
                var t, e, i, n, o, s, a;
                for (e = arguments[0], n = 2 <= arguments.length ? Y.call(arguments, 1) : [], s = 0, a = n.length; s < a; s++)
                    if (i = n[s])
                ...
                return t.prototype.on = function (t, e, i, n) {
                    ...
                    if (i = arguments[0], t = 2 <= arguments.length ? Y.call(arguments, 1) : [], null != (a = this.bindings) ? a[i] : void 0) {
                        for (o = 0, l = []; o < this.bindings[i].length;) r = this.bindings[i][o], n = r.handler, e = r.ctx, s = r.once, n.apply(null != e ? e : this, t), s ? l.push(this.bindings[i].splice(o, 1)) : l.push(o++);
                        return l
                    }
                }, t
            }(), c = window.Pace || {}, window.Pace = c, x(c, a.prototype), j = c.options = x({}, w, window.paceOptions, S()), U = ["ajax", "document", "eventLag", "elements"], _ = 0, $ = U.length; _ < $; _++) B = U[_], j[B] === !0 && (j[B] = w[B]);
        l = function (t) {
            function e() {
            ...
            return t.prototype.getElement = function () {
                ...
                for (t = this.getElement(), n = "translate3d(" + this.progress + "%, 0, 0)", a = ["webkitTransform", "msTransform", "transform"], o = 0, s = a.length; o < s; o++) e = a[o], t.children[0].style[e] = n;
            ...
            return t.prototype.trigger = function (t, e) {
                ...
                if (null != this.bindings[t]) {
                    for (s = this.bindings[t], a = [], n = 0, o = s.length; n < o; n++) i = s[n], a.push(i.call(this, e));
                    return a
                }
            ...
            var e, i, n, o;
            for (o = j.ajax.ignoreURLs, i = 0, n = o.length; i < n; i++)
            ...
            var i, n, o, s, a;
            if (s = e.type, o = e.request, a = e.url, !N(a)) return c.running || j.restartOnRequestAfter === !1 && "force" !== D(s) ? void 0 : (n = arguments, i = j.restartOnRequestAfter || 0, "boolean" == typeof i && (i = 0), setTimeout(function () {
                var e, i, a, r, l, u;
                if (e = "socket" === s ? o.readyState < 2 : 0 < (r = o.readyState) && r < 4) {
                    for (c.restart(), l = c.sources, u = [], i = 0, a = l.length; i < a; i++) {
            ...
            return t.prototype.watch = function (t) {
                var e, i, n, o;
                if (n = t.type, e = t.request, o = t.url, !N(o)) return i = "socket" === n ? new p(e) : new f(e), this.elements.push(i)
            }, t
        }(), f = function () {
            function t(t) {
                ...
                if (this.progress = 0, null != window.ProgressEvent)
                    for (i = null, t.addEventListener("progress", function (t) {
                        ...
                        }, !1), a = ["load", "abort", "timeout", "error"], n = 0, o = a.length; n < o; n++) e = a[n], t.addEventListener(e, function () {
            ...
            function t(t) {
                var e, i, n, s;
                for (null == t && (t = {}), this.elements = [], null == t.selectors && (t.selectors = []), s = t.selectors, i = 0, n = s.length; i < n; i++) e = s[i], this.elements.push(new o(e))
            }
            return t
        }(), o = function () {
            function t(t) {
            ...
            function t() {
                ...
                this.progress = 0, t = 0, o = [], n = 0, i = P(), e = setInterval(function () {
                    var a;
                    return a = P() - i - 50, i = P(), o.push(a), o.length > j.eventLag.sampleCount && o.shift(), t = g(o), ++n >= j.eventLag.minSamples && t < j.eventLag.lagThreshold ? (s.progress = 100, clearInterval(e)) : s.progress = 100 * (3 / (t + 3))
                }, 50)
            }
            return t
        }(), h = function () {
            function t(t) {
                this.source = t, this.last = this.sinceLastUpdate = 0, this.rate = j.initialRate, this.catchup = 0, this.progress = this.lastProgress = 0, null != this.source && (this.progress = L(this.source, "progress"))
            }
            ...
            var t, i, n, o, s, a, r, l;
            for (c.sources = R = [], a = ["ajax", "elements", "document", "eventLag"], i = 0, o = a.length; i < o; i++) t = a[i], j[t] !== !1 && R.push(new d[t](j[t]));
            for (l = null != (r = j.extraSources) ? r : [], n = 0, s = l.length; n < s; n++) B = l[n], R.push(new B(j));
            ...
            var t;
            return c.running = !0, v.render(), t = P(), y = !1, m = F(function (e, i) {
                var n, o, s, a, r, l, u, d, p, f, m, g, b, w, x, C;
                for (d = 100 - v.progress, o = m = 0, s = !0, l = g = 0, w = R.length; g < w; l = ++g)
                    for (B = R[l], f = null != I[l] ? I[l] : I[l] = [], r = null != (C = B.elements) ? C : [B], u = b = 0, x = r.length; b < x; u = ++b) a = r[u], p = null != f[u] ? f[u] : f[u] = new h(a), s &= p.done, p.done || (o++, m += p.tick(e));
                ...
                }, Math.max(j.ghostTime, Math.max(j.minTime - (P() - t), 0)))) : i()
            })
        }, c.start = function (t) {
            x(j, t), c.running = !0;
            try {
